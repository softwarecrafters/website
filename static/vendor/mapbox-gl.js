  ...
  return (function e(t, n, r) {
  ...
  })(
    {
            ...
            return (
              (t.prototype.pack = function (t, e) {
                ...
                for (var i, s, h, n, r = [], f = 0; f < t.length; f++)
                  if (
                    ((i = t[f].w || t[f].width), (s = t[f].h || t[f].height), (h = t[f].id), i && s)
                  ) {
        ...
        function (_dereq_, module, exports) {
          ...
          function edt1d(t, i, s, e, h) {
            ...
            for (var r = 1, a = 0; r < h; r++) {
              for (
                var n = (t[r] + r * r - (t[s[a]] + s[a] * s[a])) / (2 * r - 2 * s[a]);
                n <= e[a];
              )
          ...
          TinySDF.prototype.draw = function (t) {
            ...
            for (
              ...
              ((this.gridOuter[e] =
                1 === h ? 0 : 0 === h ? INF : Math.pow(Math.max(0, 0.5 - h), 2)),
                (this.gridInner[e] =
                  1 === h ? INF : 0 === h ? 0 : Math.pow(Math.max(0, h - 0.5), 2)));
            }
            for (
              ...
              s[e] = Math.max(
                0,
                Math.min(255, Math.round(255 - 255 * (r / this.radius + this.cutoff)))
              );
            }
            return s;
          };
        ...
        function (_dereq_, module, exports) {
          ...
          function parse_css_int(e) {
            return clamp_css_byte(
              '%' === e[e.length - 1] ? (parseFloat(e) / 100) * 255 : parseInt(e)
            );
          }
            ...
            if (-1 !== a && t + 1 === r.length) {
              ...
              switch (n) {
                ...
                case 'rgb':
                  return 3 !== s.length
                    ? null
                    : [parse_css_int(s[0]), parse_css_int(s[1]), parse_css_int(s[2]), o];
                case 'hsla':
                  if (4 !== s.length) return null;
                  o = parse_css_float(s.pop());
                case 'hsl':
      ...
      7: [
        function (_dereq_, module, exports) {
            ...
            if (e) {
              ...
              for (var o, l, u = e; e.prev !== e.next; )
                if (((o = e.prev), (l = e.next), x ? isEarHashed(e, t, i, x) : isEar(e)))
                  ...
                  a
                    ? 1 === a
                      ? ((e = cureLocalIntersections(e, n, r)), earcutLinked(e, n, r, t, i, x, 2))
          ...
          function isEarHashed(e, n, r, t) {
            ...
            for (
              var o = i.x < x.x ? (i.x < a.x ? i.x : a.x) : x.x < a.x ? x.x : a.x,
          ...
          function findHoleBridge(e, n) {
            ...
            for (t = r.next; t !== u; )
              (i >= t.x &&
                ...
                ((l = Math.abs(x - t.y) / (i - t.x)) < f || (l === f && t.x > r.x)) &&
                locallyInside(t, e) &&
                ((r = t), (f = l)),
                (t = t.next));
            return r;
          ...
          function intersects(e, n, r, t) {
            return (
              !!((equals(e, n) && equals(r, t)) || (equals(e, t) && equals(r, n))) ||
              (area(e, n, r) > 0 != area(e, n, t) > 0 && area(r, t, e) > 0 != area(r, t, n) > 0)
            );
          }
            ...
            (earcut.deviation = function (e, n, r, t) {
              ...
              for (o = 0; o < t.length; o += 3) {
                var f = t[o] * r,
                  ...
                  d = t[o + 2] * r;
                v += Math.abs(
                  (e[f] - e[d]) * (e[y + 1] - e[f + 1]) - (e[f] - e[y]) * (e[d + 1] - e[f + 1])
                );
              }
            ...
            switch (typeof r) {
              case 'object':
                ...
                for (
                  ...
                  a
                    ? ((s += '"' + u.replace(strReg, strReplace) + '":' + sss(r[u])),
                      (u = n[++e]),
                      (a = e < t && void 0 !== r[u]) && (s += ','))
                    : ((u = n[++e]), (a = e < t && void 0 !== r[u]));
                return s + '}';
              case 'undefined':
                return null;
              case 'string':
          ...
          function correct(r, e) {
            return (
              'Polygon' === r.type
                ...
                : 'MultiPolygon' === r.type &&
                  (r.coordinates = r.coordinates.map(curryOuter(correctRings, e))),
              r
            );
          }
      ...
      11: [
        function (_dereq_, module, exports) {
            ...
            for (var l = [], s = 0; s < e.length; s++) {
              ...
              for (p = 0; p < S - 1; p++)
                ((h = f || g[p]),
                  ...
                  c < r
                    ? o > t
                      ? (d.push(u(h, f, r), u(h, f, t)), i || (d = newSlice(l, d, v, m, w)))
                      : o >= r && d.push(u(h, f, r))
                    : c > t
                      ? o < r
                        ? (d.push(u(h, f, t), u(h, f, r)), i || (d = newSlice(l, d, v, m, w)))
                        : o <= t && d.push(u(h, f, t))
                      : (d.push(h),
                        o < r
                          ? (d.push(u(h, f, r)), i || (d = newSlice(l, d, v, m, w)))
                          : o > t && (d.push(u(h, f, t)), i || (d = newSlice(l, d, v, m, w)))));
              ((h = g[S - 1]),
                (c = h[n]),
                c >= r && c <= t && d.push(h),
                (a = d[d.length - 1]),
          ...
          function newSlice(e, r, t, n, u) {
            return (
              r.length && ((r.area = t), (r.dist = n), void 0 !== u && (r.outer = u), e.push(r)),
              []
            );
          }
          module.exports = clip;
            ...
            if (null !== t.geometry) {
              ...
              if ('Point' === c) e.push(createFeature(s, 1, [projectPoint(l)], p));
                ...
                for (o = 0; o < u.geometries.length; o++)
                  convertFeature(e, { geometry: u.geometries[o], properties: s }, r);
              }
            }
          }
      ...
      14: [
              ...
              for (var l = [e, t, i, o], a = this.options, u = a.debug, c = null; l.length; ) {
                ...
                if (a.solidChildren || !isClippedSquare(m, a.extent, a.buffer)) {
                  ...
                  ((g = v = M = T = null),
                    ...
                    b &&
                      ((g = clip(b, p, o - S, o + q, 1, intersectY, m.min[1], m.max[1])),
                      (v = clip(b, p, o + Z, o + w, 1, intersectY, m.min[1], m.max[1]))),
                    y &&
                      ((M = clip(y, p, o - S, o + q, 1, intersectY, m.min[1], m.max[1])),
        ...
        { './clip': 11, './convert': 12, './tile': 16, './transform': 17, './wrap': 18 },
      ],
      15: [
        function (_dereq_, module, exports) {
          'use strict';
        ...
        function (_dereq_, module, exports) {
          ...
          ((GridIndex.prototype.insert = function (t, r, e, s, i) {
            ...
            (GridIndex.prototype._queryCell = function (t, r, e, s, i, h, n) {
              ...
              if (null !== o)
                for (var l = this.keys, a = this.bboxes, d = 0; d < o.length; d++) {
                  ...
                  if (void 0 === n[f]) {
                    var u = 4 * f;
                    t <= a[u + 2] && r <= a[u + 3] && e >= a[u + 0] && s >= a[u + 1]
                      ? ((n[f] = !0), h.push(l[f]))
                      : (n[f] = !1);
                  }
                }
            ...
            (GridIndex.prototype.toArrayBuffer = function () {
              ...
              for (
                var t = this.cells, r = NUM_PARAMS + this.cells.length + 1 + 1, e = 0, s = 0;
                s < this.cells.length;
                s++
              )
          ...
          function range(p, r, s, u, h, e, o) {
            for (var a, t, n = [0, p.length - 1, 0], f = []; n.length; ) {
              ...
              if (v - g <= o)
                ...
                var d = (l + 1) % 2;
                ((0 === l ? s <= a : u <= t) && (n.push(g), n.push(c - 1), n.push(d)),
            ...
            for (; r > s; ) {
              if (r - s > 600) {
                var f = r - s + 1,
                  ...
                  n = 0.5 * Math.sqrt((w * m * (f - m)) / f) * (p - f / 2 < 0 ? -1 : 1);
                select(
                  t,
                  a,
                  o,
          ...
          function within(s, p, r, t, u, h) {
            for (var i = [0, s.length - 1, 0], o = [], n = u * u; i.length; ) {
              ...
              if (a - f <= h)
                ...
                var D = (e + 1) % 2;
                ((0 === e ? r - u <= c : t - u <= q) && (i.push(f), i.push(l - 1), i.push(D)),
      ...
      25: [
        ...
        { 'lodash.isarray': 29, 'lodash.istypedarray': 31, 'lodash.keys': 32 },
      ],
      26: [
        function (_dereq_, module, exports) {
        ...
        function (_dereq_, module, exports) {
          function isArguments(t) {
            return (
              ...
              (!propertyIsEnumerable.call(t, 'callee') || objectToString.call(t) == argsTag)
            );
          }
      ...
      30: [
        ...
        { 'lodash._baseisequal': 25, 'lodash._bindcallback': 26 },
      ],
      31: [
        function (_dereq_, module, exports) {
          function isLength(a) {
          ...
          function isTypedArray(a) {
            return (
              isObjectLike(a) && isLength(a.length) && !!typedArrayTags[objectToString.call(a)]
            );
          }
          var MAX_SAFE_INTEGER = 9007199254740991,
            argsTag = '[object Arguments]',
      ...
      32: [
        ...
        { 'lodash._getnative': 27, 'lodash.isarguments': 28, 'lodash.isarray': 29 },
      ],
      33: [
        function (_dereq_, module, exports) {
          'use strict';
          ...
          function isWebGLSupported(e) {
            ...
            return (
              ...
              t.probablySupportsContext
                ...
                : t.supportsContext
                  ? t.supportsContext('webgl', r) || t.supportsContext('experimental-webgl', r)
          ...
          ((BufferMethods = {
            ...
            toString: function (t, e, r) {
              ...
              for (var o = e; o < r; o++) {
                var u = this[o];
                u <= 127
                  ? ((n += decodeURIComponent(i) + String.fromCharCode(u)), (i = ''))
                  : (i += '%' + u.toString(16));
              }
            ...
            for (r = r || 0, o = o || a.length - 1, p = p || defaultCompare; o > r; ) {
              if (o - r > 600) {
                var f = o - r + 1,
                  ...
                  i = 0.5 * Math.sqrt((l * s * (f - s)) / f) * (e - f / 2 < 0 ? -1 : 1);
                partialSort(
                  a,
                  t,
      ...
      39: [
        function (_dereq_, module, exports) {
          ...
          function createCluster(t, e, n, o, i) {
            return { x: t, y: e, zoom: 1 / 0, id: o, properties: i, parentId: -1, numPoints: n };
          }
          function createPointCluster(t, e) {
            var n = t.geometry.coordinates;
            return { x: lngX(n[0]), y: latY(n[1]), zoom: 1 / 0, id: e, parentId: -1 };
          }
            ...
            (SuperCluster.prototype = {
              ...
              getChildren: function (t, e) {
                for (
                  var n = this.trees[e + 1].points[t],
                    o = this.options.radius / (this.options.extent * Math.pow(2, e)),
              ...
              getTile: function (t, e, n) {
                ...
                return (
                  ...
                  0 === e &&
                    this._addTileFeatures(o.range(1 - u / i, a, 1, p), o.points, i, n, i, h),
                  e === i - 1 &&
                    this._addTileFeatures(o.range(0, a, u / i, p), o.points, -1, n, i, h),
                ...
                for (var s = this.getChildren(e, n), u = 0; u < s.length; u++) {
                  ...
                  if (
                    (a.cluster
                      ? r + a.point_count <= i
                        ? (r += a.point_count)
                        : (r = this._appendLeaves(t, a.cluster_id, n + 1, o, i, r))
                      : r < i
                        ? r++
                        : t.push(s[u]),
                    t.length === o)
              ...
              _cluster: function (t, e) {
                for (
                  ...
                  if (!(r.zoom <= e)) {
                    ...
                    1 === a
                      ? n.push(r)
                      : ((r.parentId = i), n.push(createCluster(p / a, h / a, a, i, l)));
                  }
                }
                return n;
              },
        ...
        function (_dereq_, module, exports) {
          ...
          ((module.exports = TinyQueue),
            (TinyQueue.prototype = {
              ...
              _down: function (t) {
                for (
                  var i = this.data, e = this.compare, h = this.length, n = h >> 1, a = i[t];
                  t < n;
                ) {
                  var s = 1 + (t << 1),
                    u = s + 1,
      ...
      43: [
        function (_dereq_, module, exports) {
          (function (process, global) {
            ...
            function stylizeWithColor(e, r) {
              ...
              return t
                ? '[' + inspect.colors[t][0] + 'm' + e + '[' + inspect.colors[t][1] + 'm'
                : e;
            }
        ...
        { './support/isBuffer': 42, _process: 37, inherits: 41 },
      ],
      44: [
        function (_dereq_, module, exports) {
        ...
        function (_dereq_, module, exports) {
          ...
          function classifyRings(e) {
            ...
            for (var r, i, a = [], o = 0; o < t; o++) {
              ...
              0 !== n &&
                (void 0 === i && (i = n < 0),
                i === n < 0 ? (r && a.push(r), (r = [e[o]])) : r.push(e[o]));
            }
            return (r && a.push(r), a);
          }
          function signedArea(e) {
          ...
          ((module.exports = VectorTileFeature),
            ...
            (VectorTileFeature.prototype.loadGeometry = function () {
              ...
              for (
                var t, r = e.readVarint() + e.pos, i = 1, a = 0, o = 0, n = 0, s = [];
                e.pos < r;
              ) {
                if (!a) {
                  var p = e.readVarint();
      ...
      48: [
                    ...
                    ? (r =
                        e % 1 != 0
                          ...
                          : e < 0
                            ? { sint_value: e }
                            : { uint_value: e })
                    : ((e = JSON.stringify(e)), (r = { string_value: e })),
              (r.key = o + ':' + e),
              r
            );
          }
        ...
        { './lib/geojson_wrapper': 49, './vector-tile-pb': 50, pbf: 35 },
      ],
      49: [
        function (_dereq_, module, exports) {
          'use strict';
          ...
          ((module.exports = GeoJSONWrapper),
            ...
            (FeatureWrapper.prototype.bbox = function () {
              ...
              for (
                var e = this.geometry, t = 1 / 0, r = -1 / 0, o = 1 / 0, a = -1 / 0, i = 0;
                i < e.length;
                i++
              )
        ...
        { 'point-geometry': 36, 'vector-tile': 44 },
      ],
      50: [
        function (_dereq_, module, exports) {
          'use strict';
          ...
          function readValueField(e, r, i) {
            1 === e
              ? (r.string_value = i.readString())
              : 2 === e
                ? (r.float_value = i.readFloat())
                : 3 === e
                  ? (r.double_value = i.readDouble())
                  : 4 === e
                    ? (r.int_value = i.readVarint())
                    : 5 === e
                      ? (r.uint_value = i.readVarint())
                      : 6 === e
                        ? (r.sint_value = i.readSVarint())
                        : 7 === e && (r.bool_value = i.readBoolean());
          }
          ...
          function readFeatureField(e, r, i) {
            1 === e
              ? (r.id = i.readVarint())
              : 2 === e
                ? (r.tags = i.readPackedVarint())
                : 3 === e
                  ? (r.type = i.readVarint())
                  : 4 === e && (r.geometry = i.readPackedVarint());
          }
          ...
          function readLayerField(e, r, i) {
            15 === e
              ? (r.version = i.readVarint())
              : 1 === e
                ? (r.name = i.readString())
                : 2 === e
                  ? r.features.push(readFeature(i, i.readVarint() + i.pos))
                  : 3 === e
                    ? r.keys.push(i.readString())
                    : 4 === e
                      ? r.values.push(readValue(i, i.readVarint() + i.pos))
                      : 5 === e && (r.extent = i.readVarint());
          }
          ...
          ((tile.GeomType = { Unknown: 0, Point: 1, LineString: 2, Polygon: 3 }),
          ...
          module.exports = function (r, e) {
            ...
            ((l[n] = n),
              (sources[c] = [
                Function(
                  ['require'],
                  'var f = require(' + stringify(n) + ');(f.default ? f.default : f)(self);'
                ),
                l,
              ]));
            var d = {};
            ...
            var g =
                ...
                Object.keys(d)
                  .map(function (r) {
                    return (
                      stringify(r) + ':[' + sources[r][0] + ',' + stringify(sources[r][1]) + ']'
                    );
                  })
                  .join(',') +
                '},{},[' +
      ...
      54: [
        function (_dereq_, module, exports) {
          ...
          ((ArrayGroup.prototype.prepareSegment = function (r) {
            ...
            return (
              (!e || e.vertexLength + r > ArrayGroup.MAX_VERTEX_ARRAY_LENGTH) &&
                ((e = new Segment(this.layoutVertexArray.length, this.elementArray.length)),
            ...
            (ArrayGroup.prototype.prepareSegment2 = function (r) {
              ...
              return (
                (!e || e.vertexLength + r > ArrayGroup.MAX_VERTEX_ARRAY_LENGTH) &&
                  ((e = new Segment(this.layoutVertexArray.length, this.elementArray2.length)),
            ...
            (ArrayGroup.prototype.populatePaintArrays = function (r) {
              ...
              for (var t in e.layerData) {
                var a = e.layerData[t];
                0 !== a.paintVertexArray.bytesPerElement &&
                  a.programConfiguration.populatePaintArray(
                    a.layer,
                    a.paintVertexArray,
            ...
            (ArrayGroup.prototype.serialize = function (r) {
              return {
                ...
                dynamicLayoutVertexArray:
                  this.dynamicLayoutVertexArray && this.dynamicLayoutVertexArray.serialize(r),
        ...
        { './program_configuration': 68, './vertex_array_type': 70 },
      ],
      55: [
        function (_dereq_, module, exports) {
          'use strict';
          var ArrayGroup = _dereq_('./array_group'),
            ...
            Bucket = function (r, e) {
              ((this.zoom = r.zoom),
                ...
                (this.index = r.index),
                r.arrays
                  ? (this.buffers = new BufferGroup(e, r.layers, r.zoom, r.arrays))
                  : (this.arrays = new ArrayGroup(e, r.layers, r.zoom)));
            };
          ((Bucket.deserialize = function (r, e) {
            ...
            for (var i = 0, a = r; i < a.length; i += 1) {
              ...
              if (0 !== o.length)
                for (
                  var s = o[0].createBucket(util.extend({ layers: o }, u)), n = 0, f = o;
                  n < f.length;
                  n += 1
                ) {
                  var y = f[n];
        ...
        { '../util/util': 218, './array_group': 54, './buffer_group': 62 },
      ],
      56: [
        function (_dereq_, module, exports) {
          'use strict';
              ...
              return (
                ...
                (r.prototype.addFeature = function (e) {
                  for (var r = this.arrays, t = 0, c = loadGeometry(e); t < c.length; t += 1)
                    for (var a = c[t], o = 0, p = a; o < p.length; o += 1) {
                      var l = p[o],
                        i = l.x,
                        y = l.y;
        ...
        { '../bucket': 55, '../element_array_type': 63, '../extent': 64, '../load_geometry': 66 },
      ],
      57: [
        function (_dereq_, module, exports) {
          'use strict';
              ...
              return (
                ...
                (t.prototype.addFeature = function (e) {
                  for (
                    var t = this.arrays,
                      r = 0,
                      a = classifyRings(loadGeometry(e), EARCUT_MAX_RINGS);
                    r < a.length;
                    r += 1
                  ) {
                    ...
                    for (
                      var c = t.prepareSegment(n), i = c.vertexLength, y = [], u = [], s = 0, g = l;
                      s < g.length;
                      s += 1
                    ) {
                      var h = g[s];
                      if (0 !== h.length) {
                        ...
                        for (var A = 1; A < h.length; A++)
                          (t.layoutVertexArray.emplaceBack(h[A].x, h[A].y),
                            t.elementArray2.emplaceBack(f + A - 1, f + A),
                            y.push(h[A].x),
                            y.push(h[A].y));
                        ((m.vertexLength += h.length), (m.primitiveLength += h.length));
                      }
                    }
                    for (var v = earcut(y, u), _ = 0; _ < v.length; _ += 3)
                      t.elementArray.emplaceBack(i + v[_], i + v[_ + 1], i + v[_ + 2]);
                    ((c.vertexLength += n), (c.primitiveLength += v.length / 3));
                  }
              ...
              return (
                ...
                (r.prototype.addFeature = function (e) {
                  for (
                    ...
                    for (
                      var y = r.prepareSegment(5 * o), u = [], p = [], s = [], c = 0, x = n;
                      c < x.length;
                      c += 1
                    ) {
                      var f = x[c];
                      if (0 !== f.length) {
                        ...
                        for (var d = 0, m = 0; m < f.length; m++) {
                          var h = f[m];
                          if (
                            (addVertex(r.layoutVertexArray, h.x, h.y, 0, 0, 1, 1, 0),
                            s.push(y.vertexLength++),
                            m >= 1)
                          ) {
                            var g = f[m - 1];
                          ...
                          (u.push(h.x), u.push(h.y));
                        }
                      }
                    }
                    for (var _ = earcut(u, p), v = 0; v < _.length; v += 3)
                      r.elementArray.emplaceBack(s[_[v]], s[_[v + 1]], s[_[v + 2]]);
        ...
        function (_dereq_, module, exports) {
          ...
          function addLineVertex(e, t, r, i, a, n, d) {
            e.emplaceBack(
              ...
              (1 + (0 === n ? 0 : n < 0 ? -1 : 1)) | (((d * LINE_DISTANCE_SCALE) & 63) << 2),
              (d * LINE_DISTANCE_SCALE) >> 6
            );
          }
          var Bucket = _dereq_('../bucket'),
            createElementArrayType = _dereq_('../element_array_type'),
            ...
            lineInterface = {
              ...
              paintAttributes: [
                ...
                { property: 'line-width' },
                { property: 'line-width', name: 'floorwidth', useIntegerZoom: !0 },
              ],
              elementArrayType: createElementArrayType(),
            },
              ...
              return (
                ...
                (t.prototype.addFeature = function (e) {
                  for (
                    var t = this,
                      ...
                      i = r['line-join'],
                      a = r['line-cap'],
                      n = r['line-miter-limit'],
                      d = r['line-round-limit'],
                      s = 0,
                      o = loadGeometry(e, LINE_DISTANCE_BUFFER_BITS);
                    s < o.length;
                    s += 1
                  ) {
                    var u = o[s];
                ...
                (t.prototype.addLine = function (e, t, r, i, a, n) {
                  for (
                    var d = this,
                      s = t.properties,
                      o = 'Polygon' === vectorTileFeatureTypes[t.type],
                      u = e.length;
                  ...
                  if (!(u < (o ? 3 : 2))) {
                    ...
                    for (var T = l; T < u; T++)
                      if (!(A = o && T === u - 1 ? e[l + 1] : e[T + 1]) || !e[T].equals(A)) {
                        (S && (L = S),
                          y && (f = y),
                          (y = e[T]),
                        ...
                        if (
                          (F &&
                            'round' === B &&
                            (N < n ? (B = 'miter') : N <= 2 && (B = 'fakeround')),
                          'miter' === B && N > a && (B = 'bevel'),
                          'bevel' === B && (N > 2 && (B = 'flipbevel'), N < a && (B = 'miter')),
                          f && (d.distance += y.dist(f)),
                          'miter' === B)
                        )
                          (I._mult(N), d.addCurrentVertex(y, d.distance, I, 0, 0, !1, _));
                        else if ('flipbevel' === B) {
                          ...
                          if (
                            (P ? ((E = 0), (m = q)) : ((m = 0), (E = q)),
                            C || d.addCurrentVertex(y, d.distance, L, m, E, !1, _),
                            'fakeround' === B)
                          ) {
                            for (
                              var M = Math.floor(8 * (0.5 - (V - 0.5))), O = void 0, U = 0;
                              U < M;
                              U++
                            )
                              ((O = S.mult((U + 1) / (M + 1))
                          ...
                          'butt' === B
                            ? (C || d.addCurrentVertex(y, d.distance, L, 0, 0, !1, _),
                              A && d.addCurrentVertex(y, d.distance, S, 0, 0, !1, _))
                            : 'square' === B
                              ? (C ||
                                  (d.addCurrentVertex(y, d.distance, L, 1, 1, !1, _),
                                  (d.e1 = d.e2 = -1)),
                                A && d.addCurrentVertex(y, d.distance, S, -1, -1, !1, _))
                              : 'round' === B &&
                                (C ||
                                  (d.addCurrentVertex(y, d.distance, L, 0, 0, !1, _),
                                  d.addCurrentVertex(y, d.distance, L, 1, 1, !0, _),
                                  (d.e1 = d.e2 = -1)),
                                A &&
                                  (d.addCurrentVertex(y, d.distance, S, -1, -1, !0, _),
                                  d.addCurrentVertex(y, d.distance, S, 0, 0, !1, _)));
                        if (b && T < u - 1) {
                          var w = y.dist(A);
                          if (w > 2 * p) {
                            var H = y.add(
                ...
                (t.prototype.addCurrentVertex = function (e, t, r, i, a, n, d) {
                  ...
                  ((s = r.clone()),
                    ...
                    this.e1 >= 0 &&
                      this.e2 >= 0 &&
                      (p.emplaceBack(this.e1, this.e2, this.e3), d.primitiveLength++),
                    (this.e1 = this.e2),
                    (this.e2 = this.e3),
                    (s = r.mult(-1)),
                ...
                (t.prototype.addPieSliceVertex = function (e, t, r, i, a) {
                  ...
                  (addLineVertex(s, e, r, 0, n, 0, t),
                    ...
                    this.e1 >= 0 &&
                      this.e2 >= 0 &&
                      (o.emplaceBack(this.e1, this.e2, this.e3), a.primitiveLength++),
      ...
      60: [
        function (_dereq_, module, exports) {
          ...
          function getSizeData(e, t, a) {
            var o = {};
            if (
              ((o.isFeatureConstant = t.isLayoutValueFeatureConstant(a)),
              (o.isZoomConstant = t.isLayoutValueZoomConstant(a)),
              ...
              ((n = Math.min(r.length - 1, n)),
                ...
                t.isLayoutValueFeatureConstant(a) &&
                  (o.coveringStopValues = [
                    t.getLayoutValue(a, { zoom: r[i] }),
                    t.getLayoutValue(a, { zoom: r[n] }),
                  ]),
          ...
          function getSizeVertexData(e, t, a, o, r) {
            return e.isLayoutValueZoomConstant(o) && !e.isLayoutValueFeatureConstant(o)
              ? [10 * e.getLayoutValue(o, {}, r)]
              : e.isLayoutValueZoomConstant(o) || e.isLayoutValueFeatureConstant(o)
                ? null
                : [
                    10 * e.getLayoutValue(o, { zoom: a[0] }, r),
                    10 * e.getLayoutValue(o, { zoom: a[1] }, r),
                  ];
          }
          var Point = _dereq_('point-geometry'),
            ...
            SymbolBucket = function (e) {
              ...
              if (((this.symbolInterfaces = symbolInterfaces), e.arrays)) {
                this.buffers = {};
                for (var o in e.arrays)
                  e.arrays[o] &&
                    (t.buffers[o] = new BufferGroup(
                      t.symbolInterfaces[o],
                      e.layers,
                      e.zoom,
                      e.arrays[o]
                    ));
                ...
                ((this.textSizeData = getSizeData(this.zoom, a, 'text-size')),
          ...
          ((SymbolBucket.prototype.populate = function (e, t) {
            ...
            if (((this.features = []), n || l)) {
              for (
                ...
                if (o.filter(x)) {
                  var g = void 0;
                  n &&
                    ((g = o.getLayoutValue('text-field', p, x.properties)),
                    o.isLayoutValueFeatureConstant('text-field') &&
                      (g = resolveTokens(x.properties, g)),
                    (g = transformText(g, o, p, x.properties)));
                  var b = void 0;
                  if (
                    (l &&
                      ((b = o.getLayoutValue('icon-image', p, x.properties)),
                      o.isLayoutValueFeatureConstant('icon-image') &&
                        (b = resolveTokens(x.properties, b))),
                    (g || b) &&
                      (a.features.push({
                        text: g,
                        icon: b,
                    ...
                    for (
                      var v =
                          'map' === r['text-rotation-alignment'] &&
                          'line' === r['symbol-placement'],
                        S = scriptDetection.allowsVerticalWritingMode(g),
                        A = 0;
                      A < g.length;
                      A++
                    )
                      if (((c[g.charCodeAt(A)] = !0), v && S)) {
            ...
            (SymbolBucket.prototype.getPaintPropertyStatistics = function () {
              for (var e = this, t = {}, a = 0, o = e.layers; a < o.length; a += 1) {
                var r = o[a];
                t[r.id] = util.extend(
                  {},
                  e.arrays.icon.layerData[r.id].paintPropertyStatistics,
                  e.arrays.glyph.layerData[r.id].paintPropertyStatistics
                );
              }
              return t;
            }),
            ...
            (SymbolBucket.prototype.destroy = function () {
              this.buffers &&
                (this.buffers.icon && this.buffers.icon.destroy(),
            ...
            (SymbolBucket.prototype.prepare = function (e, t) {
              ...
              for (
                var r = this.layers[0].layout,
                  i = 24 * r['text-line-height'],
                  n = 'line' !== r['symbol-placement'] ? 24 * r['text-max-width'] : 0,
                  l = 24 * r['text-letter-spacing'],
                  s = (this.fontstack = r['text-font'].join(',')),
                  y = 'map' === r['text-rotation-alignment'] && 'line' === r['symbol-placement'],
                  c = 0,
                  p = a.features;
                c < p.length;
                c += 1
                ...
                if (u.text) {
                  var h = scriptDetection.allowsVerticalWritingMode(u.text),
                    x = a.layers[0]
                      .getLayoutValue('text-offset', { zoom: a.zoom }, u.properties)
                      .map(function (e) {
                        return 24 * e;
                      }),
                    d = scriptDetection.allowsLetterSpacing(u.text) ? l : 0,
                    f = a.layers[0].getLayoutValue('text-anchor', { zoom: a.zoom }, u.properties),
                    g = a.layers[0].getLayoutValue('text-justify', { zoom: a.zoom }, u.properties);
                  ((m = {}),
                    (m[WritingMode.horizontal] = shapeText(
                      u.text,
                      e[s],
                      n,
                      i,
                    ...
                    (m[WritingMode.vertical] =
                      h &&
                      y &&
                      shapeText(u.text, e[s], n, i, f, g, d, x, 24, WritingMode.vertical)));
                } else m = {};
                var b = void 0;
                if (u.icon) {
                  var v = t[u.icon];
                  v &&
                    ((b = shapeIcon(
                      v,
                      a.layers[0].getLayoutValue('icon-offset', { zoom: a.zoom }, u.properties)
                    )),
                    void 0 === a.sdfIcons
                      ? (a.sdfIcons = v.sdf)
                      : a.sdfIcons !== v.sdf &&
                    ...
                    v.isNativePixelRatio
                      ? (0 === r['icon-rotate'] &&
                          a.layers[0].isLayoutValueFeatureConstant('icon-rotate')) ||
                        (a.iconsNeedLinear = !0)
                      : (a.iconsNeedLinear = !0));
                }
            ...
            (SymbolBucket.prototype.addFeature = function (e, t, a) {
              var o = this,
                r = this.layers[0].getLayoutValue(
                  'text-size',
                  { zoom: this.zoom + 1 },
                  e.properties
                ),
                ...
                n = this.layers[0].getLayoutValue('text-offset', { zoom: this.zoom }, e.properties),
                l = this.layers[0].getLayoutValue('icon-offset', { zoom: this.zoom }, e.properties),
                s = this.layers[0].getLayoutValue('text-size', { zoom: 18 }, e.properties);
              void 0 === s && (s = r);
              var y = this.layers[0].layout,
                ...
                S =
                  y['text-allow-overlap'] ||
                  y['icon-allow-overlap'] ||
                  y['text-ignore-placement'] ||
                  y['icon-ignore-placement'],
              ...
              if ('line' === A)
                for (
                  var B = 0, L = clipLine(e.geometry, 0, 0, EXTENT, EXTENT);
                  B < L.length;
                  B += 1
                )
                  for (
                ...
                for (var _ = 0, C = classifyRings(e.geometry, 0); _ < C.length; _ += 1) {
                  var E = C[_],
                    F = findPoleOfInaccessibility(E, 16);
                  z(E[0], new Anchor(F.x, F.y, 0));
                }
              else if ('LineString' === e.type)
                for (var D = 0, O = e.geometry; D < O.length; D += 1) {
                  var q = O[D];
                  z(q, new Anchor(q[0].x, q[0].y, 0));
                }
              else if ('Point' === e.type)
                for (var N = 0, G = e.geometry; N < G.length; N += 1)
                  for (var W = G[N], R = 0, Q = W; R < Q.length; R += 1) {
                    var U = Q[R];
            ...
            (SymbolBucket.prototype.place = function (e, t) {
              ...
              if (
                ...
                r['icon-allow-overlap'] ||
                r['text-ignore-placement'] ||
                r['icon-ignore-placement']
              ) {
                var s = e.angle,
                  y = Math.sin(s),
                  c = Math.cos(s);
                this.symbolInstances.sort(function (e, t) {
                  return (
                    ((y * e.anchor.x + c * e.anchor.y) | 0) -
                      ((y * t.anchor.x + c * t.anchor.y) | 0) || t.featureIndex - e.featureIndex
                  );
                });
              }
              for (var p = 0, u = a.symbolInstances; p < u.length; p += 1) {
                var m = u[p],
                  h = { boxStartIndex: m.textBoxStartIndex, boxEndIndex: m.textBoxEndIndex },
                  x = { boxStartIndex: m.iconBoxStartIndex, boxEndIndex: m.iconBoxEndIndex },
                  d = !(m.textBoxStartIndex === m.textBoxEndIndex),
                  f = !(m.iconBoxStartIndex === m.iconBoxEndIndex),
                  g = r['text-optional'] || !d,
                  b = r['icon-optional'] || !f,
                  v = d
                    ? e.placeCollisionFeature(h, r['text-allow-overlap'], r['symbol-avoid-edges'])
                    : e.minScale,
                  S = f
                    ? e.placeCollisionFeature(x, r['icon-allow-overlap'], r['symbol-avoid-edges'])
                    : e.minScale;
                if (
                  (g || b
                    ? !b && v
                  ...
                  for (var A = m.line, I = a.lineVertexArray.length, z = 0; z < A.length; z++)
                    a.lineVertexArray.emplaceBack(A[z].x, A[z].y);
                  var B = a.lineVertexArray.length - I;
                  if (d && (e.insertCollisionFeature(h, v, r['text-ignore-placement']), v <= i)) {
                    var L = getSizeVertexData(
                      o,
                      a.zoom,
                      a.textSizeData.coveringZoomRange,
                      'text-size',
                      m.featureProperties
                    );
                    a.addSymbols(
                  ...
                  if (f && (e.insertCollisionFeature(x, S, r['icon-ignore-placement']), S <= i)) {
                    var V = getSizeVertexData(
                      o,
                      a.zoom,
                      a.iconSizeData.coveringZoomRange,
                      'icon-size',
                      m.featureProperties
                    );
                    a.addSymbols(
            ...
            (SymbolBucket.prototype.addSymbols = function (
              ...
              for (
                var h = this,
                  ...
                  g = this.zoom,
                  b = Math.max(Math.log(a) / Math.LN2 + g, 0),
                  v = this.glyphOffsetArray.length,
                  S = (c.angle + l + 2 * Math.PI) % (2 * Math.PI),
                  A =
                    (S > (1 * Math.PI) / 4 && S <= (3 * Math.PI) / 4) ||
                    (S > (5 * Math.PI) / 4 && S <= (7 * Math.PI) / 4),
                  I = Boolean(y & WritingMode.vertical) && A,
                  z = 0,
                  B = t;
                z < B.length;
                z += 1
            ...
            (SymbolBucket.prototype.addToDebugBuffers = function (e) {
              for (
                ...
                for (var c = 0; c < 2; c++) {
                  ...
                  if (p)
                    for (var u = p.boxStartIndex; u < p.boxEndIndex; u++) {
                      ...
                      if (!(1 === e.perspectiveRatio && m.maxScale < 1)) {
                        var h = m.anchorPoint,
                          ...
                          v = Math.max(
                            0,
                            Math.min(25, t.zoom + Math.log(m.placementScale) / Math.LN2)
                          ),
            ...
            (SymbolBucket.prototype.addSymbolInstance = function (
              ...
              for (var z in a) {
                var B = parseInt(z, 10);
                a[B] &&
                  ((I = I.concat(i ? getGlyphQuads(e, a[B], r, u, g, b) : [])),
                  (v = new CollisionFeature(n, t, e, l, s, y, a[B], c, p, u, !1)));
              }
              var L = v ? v.boxStartIndex : this.collisionBoxArray.length,
                V = v ? v.boxEndIndex : this.collisionBoxArray.length;
              o &&
                ((A = i ? getIconQuads(e, o, r, d, a[WritingMode.horizontal], g, b) : []),
                (S = new CollisionFeature(n, t, e, l, s, y, o, h, x, d, !0)));
              var T = S ? S.boxStartIndex : this.collisionBoxArray.length,
                M = S ? S.boxEndIndex : this.collisionBoxArray.length;
              (V > SymbolBucket.MAX_INSTANCES &&
                util.warnOnce(
              ...
              var k =
                (a[WritingMode.vertical] ? WritingMode.vertical : 0) |
                (a[WritingMode.horizontal] ? WritingMode.horizontal : 0);
        ...
        function (_dereq_, module, exports) {
          ...
          ((Buffer.fromStructArray = function (t, r) {
            ...
            (Buffer.prototype.bind = function (t) {
              var r = t[this.type];
              this.buffer
                ? (t.bindBuffer(r, this.buffer),
                  this.dynamicDraw &&
                    this.arrayBuffer &&
                    (t.bufferSubData(r, 0, this.arrayBuffer), (this.arrayBuffer = null)))
                : ((this.gl = t),
            ...
            (Buffer.prototype.enableAttributes = function (t, r) {
              for (var e = this, f = 0; f < this.attributes.length; f++) {
              ...
              for (var f = this, i = 0; i < this.attributes.length; i++) {
                ...
                void 0 !== u &&
                  t.vertexAttribPointer(
                    u,
                    a.components,
                    t[AttributeType[a.type]],
                    !1,
                    f.arrayType.bytesPerElement,
                    a.offset + (f.arrayType.bytesPerElement * e || 0)
                  );
              }
            }),
            ...
            (Buffer.BufferType = { VERTEX: 'ARRAY_BUFFER', ELEMENT: 'ELEMENT_ARRAY_BUFFER' }),
            (module.exports = Buffer));
        },
        {},
      ],
        ...
        function (_dereq_, module, exports) {
          ...
          var util = _dereq_('../util/util'),
            ...
            BufferGroup = function (e, r, t, a) {
              ...
              if (
                ((this.layoutVertexBuffer = new Buffer(
                  a.layoutVertexArray,
                  y.serialize(),
                  Buffer.BufferType.VERTEX
                )),
                a.dynamicLayoutVertexArray && e.dynamicLayoutAttributes)
              ) {
                var u = createVertexArrayType(e.dynamicLayoutAttributes);
                ((this.dynamicLayoutVertexArray = new u(a.dynamicLayoutVertexArray)),
                  (this.dynamicLayoutVertexBuffer = new Buffer(
                    a.dynamicLayoutVertexArray,
                    u.serialize(),
                    Buffer.BufferType.VERTEX,
                    !0
                  )));
              ...
              (a.elementArray &&
                ...
                (this.elementBuffer = new Buffer(
                  a.elementArray,
                  e.elementArrayType.serialize(),
                  Buffer.BufferType.ELEMENT
                )),
                a.elementArray2 &&
                  e.elementArrayType2 &&
                  (this.elementBuffer2 = new Buffer(
                    a.elementArray2,
                    e.elementArrayType2.serialize(),
                    Buffer.BufferType.ELEMENT
                  )),
                (this.layerData = {}));
              for (var i = 0, n = r; i < n.length; i += 1) {
                ...
                f.layerData[s.id] = { programConfiguration: l, paintVertexBuffer: m };
              }
              ((this.segments = a.segments), (this.segments2 = a.segments2));
              for (var B = 0, p = [f.segments, f.segments2]; B < p.length; B += 1)
                for (var c = p[B], A = 0, h = c || []; A < h.length; A += 1) {
                  var x = h[A];
                  x.vaos = util.mapObject(f.layerData, function () {
          ...
          ((BufferGroup.prototype.destroy = function () {
            ...
            for (var a = 0, f = [e.segments, e.segments2]; a < f.length; a += 1)
              for (var y = f[a], u = 0, i = y || []; u < i.length; u += 1) {
                var n = i[u];
        ...
        function (_dereq_, module, exports) {
          ...
          function createElementArrayType(e) {
            return createStructArrayType({
              members: [{ type: 'Uint16', name: 'vertices', components: e || 3 }],
            });
          }
        ...
        function (_dereq_, module, exports) {
          ...
          var Point = _dereq_('point-geometry'),
            ...
            multiPolygonIntersectsBufferedMultiPoint =
              intersection.multiPolygonIntersectsBufferedMultiPoint,
            ...
            multiPolygonIntersectsBufferedMultiLine =
              intersection.multiPolygonIntersectsBufferedMultiLine,
          ...
          ((FeatureIndex.deserialize = function (e, t, r) {
            ...
            (FeatureIndex.prototype.query = function (e, t) {
              ...
              for (var s in t)
                if (r.hasLayer(s)) {
                  ...
                  if ('line' === u.type) {
                    var y = getLineWidth(
                        r.getPaintValue('line-width', u),
                        r.getPaintValue('line-gap-width', u)
                      ),
                    ...
                    'fill' === u.type
                      ? (c = translateDistance(r.getPaintValue('fill-translate', u)))
                      : 'fill-extrusion' === u.type
                        ? (c = translateDistance(r.getPaintValue('fill-extrusion-translate', u)))
                        : 'circle' === u.type &&
                          (c =
                            r.getPaintValue('circle-radius', u) +
                            translateDistance(r.getPaintValue('circle-translate', u)));
                  l = Math.max(l, c * n);
                }
              for (
                var h = e.queryGeometry.map(function (e) {
                ...
                for (var I = h[P], m = 0; m < I.length; m++) {
                  var L = I[m];
                  ((g = Math.min(g, L.x)),
                    (p = Math.min(p, L.y)),
                    (v = Math.max(v, L.x)),
              ...
              for (var u, c = this, y = 0; y < t.length; y++) {
                ...
                if (f !== u) {
                  ...
                  if (!n || arraysIntersect(n, h)) {
                    ...
                    if (a(v))
                      for (var x = null, P = 0; P < h.length; P++) {
                        var I = h[P];
                        if (!(n && n.indexOf(I) < 0)) {
                          var m = o[I];
                          if (m) {
                            ...
                            if ('symbol' !== m.type)
                              if ((x || (x = loadGeometry(v)), 'line' === m.type)) {
                                L = translate(
                                  i,
                                  c.getPaintValue('line-translate', m, v),
                                  c.getPaintValue('line-translate-anchor', m, v),
                                  l,
                                  s
                                );
                                var M =
                                    (s / 2) *
                                    getLineWidth(
                                      c.getPaintValue('line-width', m, v),
                                      c.getPaintValue('line-gap-width', m, v)
                                    ),
                                  V = c.getPaintValue('line-offset', m, v);
                                if (
                                  (V && (x = offsetLine(x, V * s)),
                                  !multiPolygonIntersectsBufferedMultiLine(L, x, M))
                                )
                                  continue;
                                ...
                                if (
                                  ((L = translate(
                                    i,
                                    c.getPaintValue(b + '-translate', m, v),
                                    c.getPaintValue(b + '-translate-anchor', m, v),
                                    l,
                                    s
                                  )),
                                  !multiPolygonIntersectsMultiPolygon(L, x))
                                )
                                  continue;
                              } else if ('circle' === m.type) {
                                L = translate(
                                  i,
                                  c.getPaintValue('circle-translate', m, v),
                                  c.getPaintValue('circle-translate-anchor', m, v),
                                  l,
                                  s
                                );
                            ...
                            var _ = e[I];
                            (void 0 === _ && (_ = e[I] = []),
                              _.push({ featureIndex: f, feature: w }));
                          }
                        }
                      }
                  }
            ...
            (FeatureIndex.prototype.hasLayer = function (e) {
              for (var t = this, r = 0, i = t.bucketLayerIDs; r < i.length; r += 1)
                for (var a = i[r], n = 0, o = a; n < o.length; n += 1) {
                  var l = o[n];
                  if (e === l) return !0;
                }
              return !1;
            ...
            (FeatureIndex.prototype.getPaintValue = function (e, t, r) {
              if (t.isPaintValueFeatureConstant(e) || r) {
                ...
                return t.getPaintValue(e, { zoom: this.z }, i);
              }
      ...
      66: [
        function (_dereq_, module, exports) {
          ...
          module.exports = function (e, t) {
            for (
              var r = boundsLookup[t || 16], o = EXTENT / e.extent, u = e.loadGeometry(), n = 0;
              n < u.length;
              n++
            )
              for (var a = u[n], i = 0; i < a.length; i++) {
                ...
                ((d.x = Math.round(d.x * o)),
                  ...
                  (d.x < r.min || d.x > r.max || d.y < r.min || d.y > r.max) &&
                    util.warnOnce(
      ...
      68: [
        function (_dereq_, module, exports) {
          ...
          function packColor(t) {
            return [
              packUint8ToFloat(255 * t[0], 255 * t[1]),
              packUint8ToFloat(255 * t[2], 255 * t[3]),
            ];
          }
          var createVertexArrayType = _dereq_('./vertex_array_type'),
            ...
            ConstantBinder = function (t, o, r, e) {
              ((this.name = t), (this.type = o), (this.property = r), (this.useIntegerZoom = e));
            };
          ((ConstantBinder.prototype.defines = function () {
            ...
            (ConstantBinder.prototype.setUniforms = function (t, o, r, e) {
              ...
              'color' === this.type
                ? t.uniform4fv(o['u_' + this.name], i)
                : t.uniform1f(o['u_' + this.name], i);
            }));
          var SourceFunctionBinder = function (t, o, r) {
            ((this.name = t), (this.type = o), (this.property = r));
          };
            ...
            (SourceFunctionBinder.prototype.populatePaintArray = function (t, o, r, e, n, i) {
              ...
              if ('color' === this.type)
                for (var p = packColor(s), u = e; u < n; u++) {
                  var c = o.get(u);
                  ((c['a_' + a.name + '0'] = p[0]), (c['a_' + a.name + '1'] = p[1]));
                }
              else {
                for (var m = e; m < n; m++) {
                  o.get(m)['a_' + a.name] = s;
          ...
          ((CompositeFunctionBinder.prototype.defines = function () {
            ...
            (CompositeFunctionBinder.prototype.populatePaintArray = function (t, o, r, e, n, i) {
              var a = this,
                s = t.getPaintValue(this.property, { zoom: this.zoom }, i),
                p = t.getPaintValue(this.property, { zoom: this.zoom + 1 }, i);
              if ('color' === this.type)
                for (var u = packColor(s), c = packColor(p), m = e; m < n; m++) {
                  var f = o.get(m);
                  ((f['a_' + a.name + '0'] = u[0]),
                    (f['a_' + a.name + '1'] = u[1]),
                    (f['a_' + a.name + '2'] = c[0]),
                ...
                for (var y = e; y < n; y++) {
                  var h = o.get(y);
                  ((h['a_' + a.name + '0'] = s), (h['a_' + a.name + '1'] = p));
                }
            ...
            (CompositeFunctionBinder.prototype.setUniforms = function (t, o, r, e) {
              var n = e.zoom,
                i = interpolationFactor(
                  this.useIntegerZoom ? Math.floor(n) : n,
                  1,
                  this.zoom,
                  this.zoom + 1
                );
          ...
          ((ProgramConfiguration.createDynamic = function (t, o, r) {
            for (
              var e = new ProgramConfiguration(), n = [], i = 0, a = t.paintAttributes || [];
              i < a.length;
              i += 1
            ) {
              var s = a[i],
              ...
              o.isPaintValueFeatureConstant(p)
                ? ((e.binders[c] = new ConstantBinder(c, m, p, u)), (e.cacheKey += '/u_' + c))
                : o.isPaintValueZoomConstant(p)
                  ? ((e.binders[c] = new SourceFunctionBinder(c, m, p)),
                    (e.cacheKey += '/a_' + c),
                    n.push({ name: 'a_' + c, type: 'Float32', components: 'color' === m ? 2 : 1 }))
                  : ((e.binders[c] = new CompositeFunctionBinder(c, m, p, u, r)),
                    (e.cacheKey += '/z_' + c),
                    n.push({ name: 'a_' + c, type: 'Float32', components: 'color' === m ? 4 : 2 }));
            }
            return ((e.PaintVertexArray = createVertexArrayType(n)), (e.interface = t), e);
          }),
            (ProgramConfiguration.createBasicFill = function () {
              var t = new ProgramConfiguration();
              return (
                (t.binders.color = new ConstantBinder('color', 'color', 'fill-color', !1)),
                (t.cacheKey += '/u_color'),
            ...
            (ProgramConfiguration.prototype.createPaintPropertyStatistics = function () {
              var t = this,
                o = {};
              for (var r in t.binders) o[t.binders[r].property] = { max: -1 / 0 };
              return o;
            }),
      ...
      72: [
        ...
        { '../util/util': 218, './lng_lat_bounds': 73 },
      ],
      73: [
        function (_dereq_, module, exports) {
          'use strict';
          ...
          ((LngLatBounds.prototype.setNorthEast = function (t) {
            return (
              (this._ne = t instanceof LngLat ? new LngLat(t.lng, t.lat) : LngLat.convert(t)),
              this
            );
          }),
            (LngLatBounds.prototype.setSouthWest = function (t) {
              return (
                (this._sw = t instanceof LngLat ? new LngLat(t.lng, t.lat) : LngLat.convert(t)),
                this
              );
            }),
            (LngLatBounds.prototype.extend = function (t) {
              ...
              return (
                s || o
                  ...
                  : ((this._sw = new LngLat(n.lng, n.lat)), (this._ne = new LngLat(e.lng, e.lat))),
                this
              );
            }),
        ...
        function (_dereq_, module, exports) {
          ...
          ((prototypeAccessors.minZoom.get = function () {
            ...
            (prototypeAccessors.pitch.set = function (t) {
              ...
              this._pitch !== o &&
                ((this._unmodified = !1), (this._pitch = o), this._calcMatrices());
            }),
            ...
            (Transform.prototype.latY = function (t) {
              return (
                ((180 - (180 / Math.PI) * Math.log(Math.tan(Math.PI / 4 + (t * Math.PI) / 360))) *
                  this.worldSize) /
                360
              );
            }),
            ...
            (Transform.prototype._constrain = function () {
              if (this.center && this.width && this.height && !this._constraining) {
                ...
                if (l)
                  return (
                    (this.center = this.unproject(
                      new Point(o ? (a + s) / 2 : this.x, t ? (n + r) / 2 : this.y)
                    )),
                ...
                ((void 0 === i && void 0 === e) ||
                  (this.center = this.unproject(
                    new Point(void 0 !== i ? i : this.x, void 0 !== e ? e : this.y)
                  )),
                  (this._unmodified = c),
            ...
            (Transform.prototype._calcMatrices = function () {
              if (this.height) {
                ...
                var s =
                  this.worldSize /
                  (2 * Math.PI * 6378137 * Math.abs(Math.cos(this.center.lat * (Math.PI / 180))));
                if (
      ...
      77: [
            ...
            if (!e.isOpaquePass) {
              ...
              for (var s = 0; s < t.length; s++) {
                ...
                if (f) {
                  ...
                  if (
                    (m.setUniforms(a, c, i, { zoom: e.transform.zoom }),
                    a.uniform1f(c.u_camera_to_center_distance, e.transform.cameraToCenterDistance),
                    a.uniform1i(c.u_scale_with_map, 'map' === i.paint['circle-pitch-scale']),
                    'map' === i.paint['circle-pitch-alignment'])
                  ) {
                    a.uniform1i(c.u_pitch_with_map, !0);
                    var p = pixelsToTileUnits(n, 1, e.transform.zoom);
                    a.uniform2f(c.u_extrude_scale, p, p);
                  } else
                    (a.uniform1i(c.u_pitch_with_map, !1),
                  ...
                  (a.uniform1f(c.u_devicepixelratio, browser.devicePixelRatio),
                    a.uniformMatrix4fv(
                      ...
                      e.translatePosMatrix(
                        o.posMatrix,
                        n,
                        i.paint['circle-translate'],
                        i.paint['circle-translate-anchor']
                      )
                    ));
                  for (var _ = 0, v = l.segments; _ < v.length; _ += 1) {
                    var x = v[_];
                    (x.vaos[i.id].bind(
                      a,
                      c,
        ...
        { '../source/pixels_to_tile_units': 98, '../util/browser': 197 },
      ],
      78: [
        function (_dereq_, module, exports) {
          'use strict';
            ...
            for (var n = 0; n < o.length; n++) {
              ...
              if (m) {
                ...
                if (u) {
                  ...
                  var s = Math.max(
                    0,
                    Math.min(25, l.coord.z + Math.log(l.collisionTile.maxScale) / Math.LN2)
                  );
      ...
      79: [
        function (_dereq_, module, exports) {
          ...
          function drawDebugTile(r, e, a) {
            ...
            for (
              var o = createTextVerticies(a.toString(), 50, 200, 5), f = new PosArray(), n = 0;
              n < o.length;
              n += 2
            )
              f.emplaceBack(o[n], o[n + 1]);
            var l = Buffer.fromStructArray(f, Buffer.BufferType.VERTEX);
            (new VertexArrayObject().bind(t, u, l), t.uniform4f(u.u_color, 1, 1, 1, 1));
            for (
              var m = e.getTile(a).tileSize,
                s = EXTENT / (Math.pow(2, r.transform.zoom - a.z) * m),
                g = [
                  [-1, -1],
                  [-1, 1],
                  [1, -1],
          ...
          var simplexFont = {
            ...
            $: [
              ...
              [
                ...
                3, 18, 3, 16, 4, 14, 5, 13, 7, 12, 13, 10, 15, 9, 16, 8, 17, 6, 17, 3, 15, 1, 12, 0,
                8, 0, 5, 1, 3, 3,
              ],
            ],
            '%': [
            ...
            '&': [
              ...
              [
                ...
                1, 4, 2, 3, 4, 3, 6, 4, 8, 5, 9, 12, 13, 13, 14, 14, 16, 14, 18, 13, 20, 11, 21, 9,
                20, 8, 18, 8, 16, 9, 13, 11, 10, 16, 3, 18, 1, 20, 0, 22, 0, 23, 1, 23, 2,
              ],
            ],
            ...
            C: [
              21,
              [
                18, 16, 17, 18, 15, 20, 13, 21, 9, 21, 7, 20, 5, 18, 4, 16, 3, 13, 3, 8, 4, 5, 5, 3,
                7, 1, 9, 0, 13, 0, 15, 1, 17, 3, 18, 5,
              ],
            ],
            D: [
              21,
            ...
            G: [
              ...
              [
                18, 16, 17, 18, 15, 20, 13, 21, 9, 21, 7, 20, 5, 18, 4, 16, 3, 13, 3, 8, 4, 5, 5, 3,
                7, 1, 9, 0, 13, 0, 15, 1, 17, 3, 18, 5, 18, 8, -1, -1, 13, 8, 18, 8,
              ],
            ],
            ...
            e: [
              18,
              [
                3, 8, 15, 8, 15, 10, 14, 12, 13, 13, 11, 14, 8, 14, 6, 13, 4, 11, 3, 8, 3, 6, 4, 3,
            ...
            g: [
              ...
              [
                ...
                14, 8, 14, 6, 13, 4, 11, 3, 8, 3, 6, 4, 3, 6, 1, 8, 0, 11, 0, 13, 1, 15, 3,
              ],
            ],
            ...
            s: [
              17,
              [
                14, 11, 13, 13, 10, 14, 7, 14, 4, 13, 3, 11, 4, 9, 6, 8, 11, 7, 13, 6, 14, 4, 14, 3,
            ...
            '{': [
              14,
              [
                9, 25, 7, 24, 6, 23, 5, 21, 5, 19, 6, 17, 7, 16, 8, 14, 8, 12, 6, 10, -1, -1, 7, 24,
                6, 22, 6, 20, 7, 18, 8, 17, 9, 15, 9, 13, 8, 11, 4, 9, 8, 7, 9, 5, 9, 3, 8, 1, 7, 0,
                6, -2, 6, -4, 7, -6, -1, -1, 6, 8, 8, 6, 8, 4, 7, 2, 6, 1, 5, -1, 5, -3, 6, -5, 7,
                -6, 9, -7,
              ],
            ],
            '|': [8, [4, 25, 4, -7]],
            '}': [
              14,
              [
                5, 25, 7, 24, 8, 23, 9, 21, 9, 19, 8, 17, 7, 16, 6, 14, 6, 12, 8, 10, -1, -1, 7, 24,
                8, 22, 8, 20, 7, 18, 6, 17, 5, 15, 5, 13, 6, 11, 10, 9, 6, 7, 5, 5, 5, 3, 6, 1, 7,
                0, 8, -2, 8, -4, 7, -6, -1, -1, 8, 8, 6, 6, 6, 4, 7, 2, 8, 1, 9, -1, 9, -3, 8, -5,
                7, -6, 5, -7,
              ],
            ],
            '~': [
        ...
        function (_dereq_, module, exports) {
          ...
          function drawFill(t, e, r, i) {
            ...
            var l =
              ...
              r.isPaintValueFeatureConstant('fill-color') &&
              r.isPaintValueFeatureConstant('fill-opacity') &&
              1 === r.paint['fill-color'][3] &&
              1 === r.paint['fill-opacity'];
            (t.isOpaquePass === l &&
              (t.setDepthSublayer(1), drawFillTiles(t, e, r, i, drawFillTile)),
              !t.isOpaquePass &&
                r.paint['fill-antialias'] &&
                (t.lineWidth(2),
                t.depthMask(!1),
          ...
          function drawFillTiles(t, e, r, i, a) {
            if (!pattern.isPatternMissing(r.paint['fill-pattern'], t))
          ...
          function drawFillTile(t, e, r, i, a, l, n) {
            for (
              var o = t.gl,
                f = l.layerData[r.id],
                s = setFillProgram('fill', r.paint['fill-pattern'], t, f, r, i, a, n),
                p = 0,
                u = l.segments;
              p < u.length;
              p += 1
          ...
          function setFillProgram(t, e, r, i, a, l, n, o) {
            ...
            return (
              e
                ? ((f = r.useProgram(t + 'Pattern', i.programConfiguration)),
                  (o || f !== s) &&
                    (i.programConfiguration.setUniforms(r.gl, f, a, { zoom: r.transform.zoom }),
                    pattern.prepare(a.paint['fill-pattern'], r, f)),
                  pattern.setTile(l, r, f))
                : ((f = r.useProgram(t, i.programConfiguration)),
                  (o || f !== s) &&
                    i.programConfiguration.setUniforms(r.gl, f, a, { zoom: r.transform.zoom })),
              r.gl.uniformMatrix4fv(
                ...
                r.translatePosMatrix(
                  n.posMatrix,
                  l,
                  a.paint['fill-translate'],
                  a.paint['fill-translate-anchor']
                )
              ),
              f
            );
      ...
      81: [
        function (_dereq_, module, exports) {
          ...
          function renderTextureToMap(e, r, t, a) {
            ...
            (new VertexArrayObject().bind(e, i, u),
            ...
            if (n) {
              ...
              (e.gl.uniformMatrix4fv(
                ...
                e.translatePosMatrix(
                  a.posMatrix,
                  i,
                  t.paint['fill-extrusion-translate'],
                  t.paint['fill-extrusion-translate-anchor']
                )
              ),
                setLight(l, e));
            ...
            if (l || f) {
              ...
              if (d) {
                ...
                (_.uniform2f(e.u_patternscale_a, v / x, -s.height / 2),
                  ...
                  _.uniform1f(
                    e.u_sdfgamma,
                    i.lineAtlas.width / (256 * Math.min(x, T) * browser.devicePixelRatio) / 2
                  ));
              } else if (g) {
                if (
                  ((m = i.spriteAtlas.getPattern(g.from)),
                  (p = i.spriteAtlas.getPattern(g.to)),
                  !m || !p)
                )
                  return;
                (_.uniform2f(
                  e.u_pattern_size_a,
                  (m.displaySize[0] * g.fromScale) / v,
                  p.displaySize[1]
                ),
                  _.uniform2f(
                    e.u_pattern_size_b,
                    (p.displaySize[0] * g.toScale) / v,
                    p.displaySize[1]
                  ),
                  _.uniform2fv(e.u_texsize, i.spriteAtlas.getPixelSize()));
              }
              _.uniform2f(
                e.u_gl_units_to_pixels,
                1 / i.transform.pixelsToGLUnits[0],
                1 / i.transform.pixelsToGLUnits[1]
              );
            }
            (l &&
              (d
                ? (_.uniform1i(e.u_image, 0),
                  _.activeTexture(_.TEXTURE0),
                  i.lineAtlas.bind(_),
                  _.uniform1f(e.u_tex_y_a, s.y),
                  _.uniform1f(e.u_tex_y_b, u.y),
                  _.uniform1f(e.u_mix, d.t))
                : g &&
                  (_.uniform1i(e.u_image, 0),
                  _.activeTexture(_.TEXTURE0),
                  i.spriteAtlas.bind(_, !0),
                  _.uniform2fv(e.u_pattern_tl_a, m.tl),
                  _.uniform2fv(e.u_pattern_br_a, m.br),
                  _.uniform2fv(e.u_pattern_tl_b, p.tl),
                  _.uniform2fv(e.u_pattern_br_b, p.br),
                  _.uniform1f(e.u_fade, g.t))),
              i.enableTileClippingMask(n));
            var b = i.translatePosMatrix(
              n.posMatrix,
              t,
              a.paint['line-translate'],
              a.paint['line-translate-anchor']
            );
            (_.uniformMatrix4fv(e.u_matrix, !1, b),
              _.uniform1f(e.u_ratio, 1 / pixelsToTileUnits(t, 1, i.transform.zoom)));
            for (var c = 0, h = r.segments; c < h.length; c += 1) {
              var S = h[c];
              (S.vaos[a.id].bind(
                _,
                e,
                r.layoutVertexBuffer,
                r.elementBuffer,
                o.paintVertexBuffer,
                S.vertexOffset
              ),
          ...
          module.exports = function (e, i, t, r) {
            if (!e.isOpaquePass) {
              ...
              if ((a.enable(a.STENCIL_TEST), !(t.paint['line-width'] <= 0)))
                for (
                  var n,
                    o = t.paint['line-dasharray']
                      ? 'lineSDF'
                      : t.paint['line-pattern']
                        ? 'linePattern'
                        : 'line',
                    l = !0,
                    f = 0,
                  ...
                  if (p) {
                    var _ = p.buffers.layerData[t.id],
                      ...
                      x = n !== m.coord.z;
                    (v &&
                      _.programConfiguration.setUniforms(e.gl, g, t, { zoom: e.transform.zoom }),
      ...
      83: [
        function (_dereq_, module, exports) {
          ...
          function drawRasterTile(r, t, e, a) {
            ...
            ((o.boundsVAO || r.rasterBoundsVAO).bind(i, u, m),
          ...
          function getFadeValues(r, t, e, a) {
            ...
            if (r.sourceCache && i > 0) {
              ...
              return (
                r.refreshedUponExpiration && n >= 1 && (r.refreshedUponExpiration = !1),
                t ? { opacity: 1, mix: 1 - d } : { opacity: d, mix: 0 }
              );
            }
        ...
        function (_dereq_, module, exports) {
            ...
            if (!t.isOpaquePass) {
              ...
              (o ? r.disable(r.STENCIL_TEST) : r.enable(r.STENCIL_TEST),
                ...
                drawLayerSymbols(
                  ...
                  a,
                  !1,
                  i.paint['icon-translate'],
                  i.paint['icon-translate-anchor'],
                  i.layout['icon-rotation-alignment'],
                  i.layout['icon-pitch-alignment'],
                  i.layout['icon-keep-upright']
                ),
                drawLayerSymbols(
                  t,
                  e,
                  ...
                  a,
                  !0,
                  i.paint['text-translate'],
                  i.paint['text-translate-anchor'],
                  i.layout['text-rotation-alignment'],
                  i.layout['text-pitch-alignment'],
                  i.layout['text-keep-upright']
                ),
          ...
          function drawLayerSymbols(t, e, i, a, o, r, n, l, s, u) {
            if (o || !t.style.sprite || t.style.sprite.loaded()) {
              ...
              for (var b, x, d = 0, g = a; d < g.length; d += 1) {
                var S = g[d],
                  T = e.getTile(S),
                  h = T.getBucket(i);
                if (h) {
                  ...
                  if (v && v.segments.length) {
                    ...
                    ((b && h.fontstack === x) ||
                      ((b = t.useProgram(E ? 'symbolSDF' : 'symbolIcon', w)),
                      w.setUniforms(m, b, i, { zoom: t.transform.zoom }),
                      setSymbolDrawState(
                        b,
                        t,
                        i,
                      ...
                      m.uniformMatrix4fv(
                        b.u_matrix,
                        !1,
                        t.translatePosMatrix(S.posMatrix, T, r, n)
                      ));
                    ...
                    (m.uniformMatrix4fv(
                      b.u_gl_coord_matrix,
                      !1,
                      t.translatePosMatrix(L, T, r, n, !0)
                    ),
                      _
                        ? (m.uniformMatrix4fv(b.u_label_plane_matrix, !1, identityMat4),
                          symbolProjection.updateLineLabels(h, S.posMatrix, t, o, C, L, c, u, D, i))
                        : m.uniformMatrix4fv(b.u_label_plane_matrix, !1, C),
          ...
          function setSymbolDrawState(t, e, i, a, o, r, n, l, s, u, m) {
            var f = e.gl,
              c = e.transform;
            if (
              (f.uniform1i(t.u_pitch_with_map, l),
              f.activeTexture(f.TEXTURE0),
              f.uniform1i(t.u_texture, 0),
              f.uniform1f(t.u_is_text, o ? 1 : 0),
              o)
            ) {
              ...
              var y = e.options.rotating || e.options.zooming,
                p =
                  !i.isLayoutValueFeatureConstant('icon-size') ||
                  !i.isLayoutValueZoomConstant('icon-size') ||
                  1 !== i.getLayoutValue('icon-size', { zoom: c.zoom }),
                b = p || u,
                x = l || c.pitch;
          ...
          function drawSymbolElements(t, e, i, a) {
            for (
              var o = t.layerData[e.id], r = o && o.paintVertexBuffer, n = 0, l = t.segments;
              n < l.length;
              n += 1
            ) {
              var s = l[n];
        ...
        function (_dereq_, module, exports) {
          ...
          ((LineAtlas.prototype.setSprite = function (t) {
            ...
            (LineAtlas.prototype.addDash = function (t, i) {
              ...
              for (var n = this.width / a, o = n / 2, E = t.length % 2 == 1, T = -h; T <= h; T++)
                for (
                  var R = e.nextRow + h + T,
                    u = e.width * R,
                    d = E ? -t[t.length - 1] : 0,
          ...
          ((Painter.prototype.resize = function (e, r) {
            ...
            ((this.width = e * browser.devicePixelRatio),
              ...
              this.viewportTexture &&
                (this.gl.deleteTexture(this.viewportTexture), (this.viewportTexture = null)),
              this.viewportFbo &&
                (this.gl.deleteFramebuffer(this.viewportFbo), (this.viewportFbo = null)));
          }),
            ...
            (Painter.prototype.renderPass = function () {
              ...
              for (var a = 0; a < t.length; a++) {
                ...
                (s.source !== (e && e.id) &&
                  ((e = r.style.sourceCaches[s.source]),
                  (i = []),
                  e &&
                    (e.prepare && e.prepare(),
                    r.clearStencil(),
                    (i = e.getVisibleCoordinates()),
                    e.getSource().isTileClipped && r._renderTileClippingMasks(i)),
                  r.isOpaquePass || i.reverse()),
            ...
            (Painter.prototype.createProgram = function (e, r) {
              var t = this.gl,
                ...
                a = r
                  .defines()
                  .concat('#define DEVICE_PIXEL_RATIO ' + browser.devicePixelRatio.toFixed(1));
              this._showOverdrawInspector && a.push('#define OVERDRAW_INSPECTOR;');
              var s = a
                  .concat(shaders.prelude.fragmentSource, shaders[e].fragmentSource)
                  .join('\n'),
                o = a.concat(shaders.prelude.vertexSource, shaders[e].vertexSource).join('\n'),
                n = t.createShader(t.FRAGMENT_SHADER);
              (t.shaderSource(n, s), t.compileShader(n), t.attachShader(i, n));
              var l = t.createShader(t.VERTEX_SHADER);
              (t.shaderSource(l, o), t.compileShader(l), t.attachShader(i, l));
              for (
                var h = r.interface ? r.interface.layoutAttributes : [], c = 0;
                c < h.length;
                c++
              )
                t.bindAttribLocation(i, c, h[c].name);
              t.linkProgram(i);
              for (
                var u = t.getProgramParameter(i, t.ACTIVE_ATTRIBUTES),
                  p = { program: i, numAttributes: u },
                  d = 0;
                d < u;
                d++
              ) {
            ...
            (Painter.prototype._createProgramCached = function (e, r) {
              ...
              var t =
                '' + e + (r.cacheKey || '') + (this._showOverdrawInspector ? '/overdraw' : '');
            ...
            (Painter.prototype.useProgram = function (e, r) {
              ...
              return (
                this.currentProgram !== i && (t.useProgram(i.program), (this.currentProgram = i)),
                i
              );
            }),
          ...
          ((exports.isPatternMissing = function (t, r) {
            ...
            (exports.setTile = function (t, r, e) {
              ...
              i.uniform1f(
                ...
                1 / pixelsToTileUnits(t, 1, r.transform.tileZoom)
              );
        ...
        function (_dereq_, module, exports) {
          ...
          ((VertexArrayObject.prototype.bind = function (e, t, r, i, n, s, b) {
            void 0 === e.extVertexArrayObject &&
              (e.extVertexArrayObject = e.getExtension('OES_vertex_array_object'));
            var u =
              !this.vao ||
              this.boundProgram !== t ||
            ...
            !e.extVertexArrayObject || u
              ? (this.freshBind(e, t, r, i, n, s, b), (this.gl = e))
              : (e.extVertexArrayObject.bindVertexArrayOES(this.vao), b && b.bind(e));
          }),
            ...
            (VertexArrayObject.prototype.destroy = function () {
              this.vao &&
                (this.gl.extVertexArrayObject.deleteVertexArrayOES(this.vao), (this.vao = null));
            }),
      ...
      92: [
            ...
            CanvasSource = (function (t) {
              ...
              return (
                ...
                (i.prototype.load = function () {
                  if (
                    ((this.canvas =
                      this.canvas || window.document.getElementById(this.options.canvas)),
                  ...
                  (this.canvas.width !== this.width && ((this.width = this.canvas.width), (t = !0)),
                    ...
                    this._hasInvalidDimensions() ||
                      (0 !== Object.keys(this.tiles).length &&
                        this._prepareImage(this.map.painter.gl, this.canvas, t)));
                }),
                ...
                (i.prototype._hasInvalidDimensions = function () {
                  for (
                    var t = this, i = 0, a = [t.canvas.width, t.canvas.height];
                    i < a.length;
                    i += 1
                  ) {
                    var s = a[i];
        ...
        { '../util/window': 199, './image_source': 96 },
      ],
      93: [
        function (_dereq_, module, exports) {
          'use strict';
            ...
            GeoJSONSource = (function (t) {
                ...
                this.workerOptions = util.extend(
                  {
                    ...
                    geojsonVtOptions: {
                      ...
                      tolerance: (void 0 !== o.tolerance ? o.tolerance : 0.375) * a,
                      extent: EXTENT,
              ...
              return (
                ...
                (e.prototype.loadTile = function (t, e) {
                  var o = this,
                    ...
                    r = {
                      ...
                      source: this.id,
                      overscaling:
                        t.coord.z > this.maxzoom ? Math.pow(2, t.coord.z - this.maxzoom) : 1,
                  ...
                  t.workerID = this.dispatcher.send(
                    ...
                    function (i, r) {
                      if ((t.unloadVectorData(), !t.aborted))
                        return i
                          ? e(i)
                          : (t.loadVectorData(r, o.map.painter),
                            t.redoWhenDone && ((t.redoWhenDone = !1), t.redoPlacement(o)),
                            e(null));
                    },
                    this.workerID
                  );
                ...
                (e.prototype.serialize = function () {
                  return util.extend({}, this._options, { type: this.type, data: this._data });
                }),
                e
              );
            })(Evented);
      ...
      95: [
        ...
        { '../data/extent': 64, 'point-geometry': 36, 'vector-tile': 44 },
      ],
      96: [
        function (_dereq_, module, exports) {
          'use strict';
            ...
            ImageSource = (function (t) {
              ...
              return (
                ...
                (e.prototype.load = function () {
                  ...
                  (this.fire('dataloading', { dataType: 'source' }),
                    ...
                    ajax.getImage(this.options.url, function (e, o) {
                      e ? t.fire('error', { error: e }) : o && ((t.image = o), t._finishLoading());
                    }));
                }),
                ...
                (e.prototype.setCoordinates = function (t) {
                  ...
                  return (
                    ...
                    (this._tileCoords = o.map(function (t) {
                      ...
                      return new Point(
                        Math.round((e.column - r.column) * EXTENT),
                        Math.round((e.row - r.row) * EXTENT)
                      );
                    })),
                ...
                (e.prototype.prepare = function () {
                  (0 === Object.keys(this.tiles).length) !== 0 &&
                    this.image &&
                ...
                (e.prototype.loadTile = function (t, e) {
                  this.coord && this.coord.toString() === t.coord.toString()
                    ? (this._setTile(t), e(null))
      ...
      97: [
        ...
        { '../util/ajax': 196, '../util/browser': 197, '../util/mapbox': 212, '../util/util': 218 },
      ],
      98: [
        function (_dereq_, module, exports) {
          'use strict';
        ...
        function (_dereq_, module, exports) {
          ...
          function mergeRenderedFeatureLayers(e) {
            for (var r = {}, t = {}, o = 0, a = e; o < a.length; o += 1) {
              ...
              for (var s in u)
                for (
                  var l = u[s], c = (d[s] = d[s] || {}), f = (r[s] = r[s] || []), y = 0, p = l;
                  y < p.length;
                  y += 1
                ) {
                  var v = p[y];
          ...
          ((exports.rendered = function (e, r, t, o, a, n) {
            ...
            (exports.source = function (e, r) {
              for (
                var t = e.getRenderableIds().map(function (r) {
                ...
                var u = t[n],
                  i = new TileCoord(Math.min(u.sourceMaxZoom, u.coord.z), u.coord.x, u.coord.y, 0)
                    .id;
            ...
            RasterTileSource = (function (e) {
              ...
              return (
                    ...
                    loadTileJSON(this._options, function (t, i) {
                      t
                        ...
                        : i &&
                          ...
                          e.fire('data', { dataType: 'source', sourceDataType: 'metadata' }),
                          e.fire('data', { dataType: 'source', sourceDataType: 'content' }));
                    }));
                }),
                ...
                (t.prototype.loadTile = function (e, t) {
                  ...
                  e.request = ajax.getImage(r, function (r, o) {
                    if ((delete e.request, e.aborted)) ((i.state = 'unloaded'), t(null));
                      ...
                      ((e.texture = i.map.painter.getTileTexture(o.width)),
                        e.texture
                          ? (a.bindTexture(a.TEXTURE_2D, e.texture),
                            a.texSubImage2D(a.TEXTURE_2D, 0, 0, 0, a.RGBA, a.UNSIGNED_BYTE, o))
                          : ((e.texture = a.createTexture()),
                            ...
                            a.texImage2D(a.TEXTURE_2D, 0, a.RGBA, a.RGBA, a.UNSIGNED_BYTE, o),
      ...
      101: [
        function (_dereq_, module, exports) {
          ...
          ((module.exports.evented = new Evented()),
            (module.exports.registerForPluginAvailability = function (e) {
              return (
                pluginBlobURL
                  ? e({ pluginBlobURL: pluginBlobURL, errorCallback: module.exports.errorCallback })
        ...
        { '../util/ajax': 196, '../util/evented': 205, '../util/window': 199 },
      ],
      102: [
        function (_dereq_, module, exports) {
          'use strict';
          ...
          ((exports.create = function (e, r, o, u) {
            ...
            if (s.id !== e)
              throw new Error('Expected Source id to be ' + e + ' instead of ' + s.id);
            return (util.bindAll(['load', 'abort', 'unload', 'serialize', 'prepare'], s), s);
          }),
              ...
              return (
                ...
                (t.prototype._tileLoaded = function (e, t, o, i) {
                  if (i)
                    return (
                      (e.state = 'errored'),
                      void (404 !== i.status && this._source.fire('error', { tile: e, error: i }))
                    );
                  ((e.sourceCache = this),
                    (e.timeAdded = new Date().getTime()),
                    'expired' === o && (e.refreshedUponExpiration = !0),
                    this._setTileReloadTimer(t, e),
                    this._source.fire('data', { dataType: 'source', tile: e, coord: e.coord }),
                ...
                (t.prototype.findLoadedParent = function (e, t, o) {
                  for (var i = this, r = e.z - 1; r >= t; r--) {
                    ...
                    if (i._cache.has(e.id))
                      return ((o[e.id] = !0), i._cache.getWithoutRemoving(e.id));
                  }
                }),
                ...
                (t.prototype.update = function (e) {
                  ...
                  if (((this.transform = e), this._sourceLoaded && !this._paused)) {
                    ...
                    for (
                      this.used
                        ? this._source.coord
                          ? (u = e.getVisibleWrappedCoordinates(this._source.coord))
                          : ((u = e.coveringTiles({
                      ...
                      ((r = u[i]),
                        ...
                        (c[r.id] = !0),
                        s.hasData() ||
                          o._findLoadedChildren(r, h, c) ||
                          ((a = o.findLoadedParent(r, d, c)) && o._addTile(a.coord)));
                    var l = {};
                    if (isRasterType(this._source.type))
                      for (var _ = Object.keys(c), m = 0; m < _.length; m++) {
                        var p = _[m];
                        ((r = TileCoord.fromID(p)),
                          (s = o._tiles[p]),
                          s &&
                            (void 0 === s.fadeEndTime || s.fadeEndTime >= Date.now()) &&
                            (o._findLoadedChildren(r, h, c) && (c[p] = !0),
                            (a = o.findLoadedParent(r, d, l)) && o._addTile(a.coord)));
                      }
                    var f;
                ...
                (t.prototype._setTileReloadTimer = function (e, t) {
                  ...
                  i &&
                    (this._timers[e] = setTimeout(function () {
                      (o._reloadTile(e, 'expired'), (o._timers[e] = void 0));
                    }, i));
                }),
                ...
                (t.prototype._removeTile = function (e) {
                  ...
                  if (
                    ...
                    this._timers[e] && (clearTimeout(this._timers[e]), (this._timers[e] = void 0)),
                    !(t.uses > 0))
                  )
                ...
                (t.prototype.tilesIn = function (e) {
                  ...
                  for (var u = 0; u < i.length; u++) {
                    var l = t._tiles[i[u]],
                      ...
                      m = [
                        coordinateToTilePoint(_, l.sourceMaxZoom, new Coordinate(r, s, d)),
                        coordinateToTilePoint(_, l.sourceMaxZoom, new Coordinate(a, n, d)),
                      ];
                ...
                (t.prototype.getVisibleCoordinates = function () {
                  for (
                    var e = this, t = this.getRenderableIds().map(TileCoord.fromID), o = 0, i = t;
                    o < i.length;
                    o += 1
                  ) {
                    var r = i[o];
          ...
          ((Tile.prototype.registerFadeDuration = function (e, t) {
              ...
              this.placementSource.dispatcher.send(
                ...
                function (t, i) {
                  ((e.state = 'loaded'),
                    ...
                    e.placementSource.fire('data', { tile: e, coord: e.coord, dataType: 'source' }),
            ...
            (Tile.prototype.querySourceFeatures = function (e, t) {
              ...
              if (this.rawTileData) {
                ...
                if (a)
                  for (
                    var r = featureFilter(t && t.filter),
              ...
              if (this.expirationTime) {
                ...
                if (this.expirationTime > o) a = !1;
                  ...
                  if (this.expirationTime < t) a = !0;
                    ...
                    r
                      ? (this.expirationTime = o + Math.max(r, CLOCK_SKEW_RETRY_TIMEOUT))
                      : (a = !0);
                  }
                else a = !0;
                a
      ...
      105: [
        function (_dereq_, module, exports) {
          ...
          ((TileBounds.prototype.validateBounds = function (t) {
            return Array.isArray(t) && 4 === t.length
              ? [Math.max(-180, t[0]), Math.max(-90, t[1]), Math.min(180, t[2]), Math.min(90, t[3])]
              : [-180, -90, 180, 90];
          }),
        ...
        { '../geo/lng_lat_bounds': 73, '../util/util': 218 },
      ],
      106: [
        function (_dereq_, module, exports) {
          'use strict';
          ...
          function scanSpans(t, i, o, r, e) {
            ...
            for (
              var a = t.dx / t.dy, d = i.dx / i.dy, y = t.dx > 0, l = i.dx < 0, u = n;
              u < h;
              u++
            ) {
          ...
          ((TileCoord.prototype.toString = function () {
            ...
            (TileCoord.prototype.url = function (t, i, o) {
              ...
              return t[(this.x + this.y) % t.length]
                ...
                .replace('{y}', String('tms' === o ? Math.pow(2, this.z) - this.y - 1 : this.y))
                .replace('{quadkey}', e)
        ...
        { '../geo/coordinate': 71, '@mapbox/whoots-js': 5 },
      ],
      107: [
        function (_dereq_, module, exports) {
          'use strict';
              ...
              return (
                ...
                (t.prototype.loadTile = function (e, t) {
                  function i(i, o) {
                    if (!e.aborted) {
                      ...
                      (this.map._refreshExpiredTiles && e.setExpiryData(o),
                        ...
                        t(null),
                        e.reloadCallback &&
                          (this.loadTile(e, e.reloadCallback), (e.reloadCallback = null)));
                    }
                  }
                  ...
                  e.workerID && 'expired' !== e.state
                    ? 'loading' === e.state
                      ? (e.reloadCallback = t)
                      : this.dispatcher.send('reloadTile', r, i.bind(this), e.workerID)
                    : (e.workerID = this.dispatcher.send('loadTile', r, i.bind(this)));
                }),
                (t.prototype.abortTile = function (e) {
                  this.dispatcher.send(
                    'abortTile',
      ...
      108: [
        function (_dereq_, module, exports) {
          ...
          function loadVectorTile(e, r) {
            var o = ajax.getArrayBuffer(e.url, function (e, o) {
              e
                ? r(e)
                : o &&
                  r(null, {
          ...
          ((VectorTileWorkerSource.prototype.loadTile = function (e, r) {
            ...
            i.abort = this.loadVectorData(e, function (e, l) {
              ...
              (l.expires && (n.expires = l.expires),
                ...
                i.parse(l.vectorTile, o.layerIndex, o.actor, function (e, o, t) {
                  if (e || !o) return r(e);
            ...
            (VectorTileWorkerSource.prototype.reloadTile = function (e, r) {
              ...
              if (t && t[a]) {
                ...
                'parsing' === l.status
                  ? (l.reloadCallback = r)
                  : 'done' === l.status &&
                    l.parse(l.vectorTile, this.layerIndex, this.actor, o.bind(l));
              }
            }),
                    ...
                    ajax.getVideo(t.urls, function (t, o) {
                      if (t) e.fire('error', { error: t });
                        ...
                        (e.video.addEventListener('playing', function () {
                          ((i = e.map.style.animationLoop.set(1 / 0)), e.map._rerender());
                        }),
        ...
        function (_dereq_, module, exports) {
          ...
          ((Worker.prototype.setLayers = function (e, r) {
            ...
            (Worker.prototype.loadRTLTextPlugin = function (e, r, o) {
              try {
                globalRTLTextPlugin.applyArabicShaping ||
                  ...
                  (globalRTLTextPlugin.applyArabicShaping &&
                    globalRTLTextPlugin.processBidirectionalText) ||
                    o(new Error('RTL Text Plugin failed to import scripts from ' + r)));
              } catch (e) {
                o(e);
              }
            }),
            ...
            (Worker.prototype.getWorkerSource = function (e, r) {
              var o = this;
              if (
                (this.workerSources[e] || (this.workerSources[e] = {}), !this.workerSources[e][r])
              ) {
                var t = {
      ...
      111: [
        function (_dereq_, module, exports) {
          ...
          ((WorkerTile.prototype.parse = function (e, i, r, t) {
            ...
            a.bucketLayerIDs = [];
            var n = {},
              l = { featureIndex: a, iconDependencies: {}, glyphDependencies: {} },
            ...
            for (var u in c) {
              ...
              if (h) {
                ...
                for (var y = s.encode(u), m = [], d = 0; d < h.length; d++) {
                  var p = h.feature(d);
                  m.push({ feature: p, index: d, sourceLayerIndex: y });
                }
                for (var f = 0, v = c[u]; f < v.length; f += 1) {
                  var g = v[f],
                    T = g[0];
                  if (
                    !(T.minzoom && o.zoom < T.minzoom) &&
                    !(
                      (T.maxzoom && o.zoom >= T.maxzoom) ||
                      (T.layout && 'none' === T.layout.visibility)
                    )
                  ) {
                    for (var x = 0, b = g; x < b.length; x += 1) {
            ...
            var D = 0,
              ...
              w = util.mapObject(l.glyphDependencies, function (e) {
            ...
            (Object.keys(w).length
              ? r.send('getGlyphs', { uid: this.uid, stacks: w }, function (e, i) {
                  ((w = i), A(e));
                })
              : A(),
              C.length
                ? r.send('getIcons', { icons: C }, function (e, i) {
                    ((C = i), A(e));
                  })
                : A());
          }),
        ...
        function (_dereq_, module, exports) {
          ...
          function diffSources(e, r, o, a) {
            ...
            for (s in e)
              e.hasOwnProperty(s) &&
                (r.hasOwnProperty(s) ||
                  (o.push({ command: operations.removeSource, args: [s] }), (a[s] = !0)));
            for (s in r)
              r.hasOwnProperty(s) &&
                (e.hasOwnProperty(s)
                  ? isEqual(e[s], r[s]) ||
          ...
          function diffLayerPropertyChanges(e, r, o, a, s, t) {
            ...
            for (n in e)
              e.hasOwnProperty(n) &&
                (isEqual(e[n], r[n]) || o.push({ command: t, args: [a, n, r[n], s] }));
            for (n in r)
              r.hasOwnProperty(n) &&
                !e.hasOwnProperty(n) &&
                (isEqual(e[n], r[n]) || o.push({ command: t, args: [a, n, r[n], s] }));
                ...
                if (
                  ...
                  (diffLayerPropertyChanges(
                    ...
                    isEqual(n.filter, i.filter) ||
                      o.push({ command: operations.setFilter, args: [t, i.filter] }),
                    (isEqual(n.minzoom, i.minzoom) && isEqual(n.maxzoom, i.maxzoom)) ||
                      o.push({
                  ...
                  for (m in n)
                    n.hasOwnProperty(m) &&
                      ...
                      (0 === m.indexOf('paint.')
                        ...
                        : isEqual(n[m], i[m]) ||
                          o.push({ command: operations.setLayerProperty, args: [t, m, i[m]] }));
                  for (m in i)
                    i.hasOwnProperty(m) &&
                      !n.hasOwnProperty(m) &&
                      'layout' !== m &&
          ...
          function diffStyles(e, r) {
            ...
            try {
              ...
              (isEqual(e.center, r.center) ||
                ...
                isEqual(e.zoom, r.zoom) || o.push({ command: operations.setZoom, args: [r.zoom] }),
                ...
                isEqual(e.transition, r.transition) ||
                  o.push({ command: operations.setTransition, args: [r.transition] }),
                      ...
                      : '<' === i || '>' === i || '<=' === i || '>=' === i
                        ...
                        : 'any' === i
                          ...
                          : 'all' === i
                            ? compileLogicalOp(e.slice(1), '&&')
                            : 'none' === i
                              ? compileNegation(compileLogicalOp(e.slice(1), '||'))
                              : 'in' === i
                                ? compileInOp(e[1], e.slice(2))
                                : '!in' === i
                                  ? compileNegation(compileInOp(e[1], e.slice(2)))
                                  : 'has' === i
                                    ? compileHasOp(e[1])
                                    : '!has' === i
      ...
      116: [
        function (_dereq_, module, exports) {
          ...
          function xyz2rgb(r) {
            return 255 * (r <= 0.0031308 ? 12.92 * r : 1.055 * Math.pow(r, 1 / 2.4) - 0.055);
          }
          function rgb2xyz(r) {
          ...
          function rgbToLab(r) {
            ...
            return [
              116 * o - 16,
              500 * (b - o),
              200 * (o - xyz2lab((0.0193339 * t + 0.119192 * a + 0.9503041 * n) / Zn)),
              r[3],
            ];
          }
          function labToRgb(r) {
      ...
      117: [
        function (_dereq_, module, exports) {
          ...
          function evaluateCategoricalFunction(t, e, o, n, r) {
            return coalesce(typeof o === r ? n[o] : void 0, t.default, e.default);
          }
          ...
          function evaluateIdentityFunction(t, e, o) {
            return (
              'color' === e.type
                ? (o = parseColor(o))
                : getType(o) === e.type || ('enum' === e.type && e.values[o]) || (o = void 0),
      ...
      118: [
        ...
        { './util/ref_properties': 125, 'fast-stable-stringify': 8 },
      ],
      119: [
        function (_dereq_, module, exports) {
          'use strict';
      ...
      126: [
        function (_dereq_, module, exports) {
          'use strict';
          module.exports = function (n) {
            return n instanceof Number || n instanceof String || n instanceof Boolean
              ? n.valueOf()
              : n;
          };
        },
      ...
      128: [
        ...
        { '../error/validation_error': 114, '../util/get_type': 122, './validate': 127 },
      ],
      129: [
        function (_dereq_, module, exports) {
          'use strict';
        ...
        { '../error/validation_error': 114, '../util/get_type': 122 },
      ],
      130: [
        function (_dereq_, module, exports) {
          'use strict';
        ...
        { '../error/validation_error': 114, '../util/get_type': 122, csscolorparser: 6 },
      ],
      131: [
        function (_dereq_, module, exports) {
          'use strict';
          ...
          module.exports = function (r) {
            ...
            if (r.styleSpec.$version > 7)
              return t
                ? [new ValidationError(e, t, 'constants have been deprecated as of v8')]
                : [];
            var a = getType(t);
            ...
            for (var n in t)
              '@' !== n[0] &&
                o.push(new ValidationError(e + '.' + n, t[n], 'constants must start with "@"'));
            return o;
          };
        },
        { '../error/validation_error': 114, '../util/get_type': 122 },
      ...
      132: [
        ...
        { '../error/validation_error': 114, '../util/unbundle_jsonlint': 126 },
      ],
      133: [
        function (_dereq_, module, exports) {
          'use strict';
            ...
            switch (
              ...
              case '>=':
                a.length >= 2 &&
                  '$type' === unbundle(a[1]) &&
                  s.push(
                    new ValidationError(n, a, '"$type" cannot be use with operator "%s"', a[0])
                  );
              case '==':
              case '!=':
                3 !== a.length &&
              ...
              case '!in':
                a.length >= 2 &&
                  ...
                  s.push(new ValidationError(n + '[1]', a[1], 'string expected, %s found', t));
          ...
          module.exports = function (e) {
            function t(e) {
              ...
              return (
                ...
                'array' === getType(a) &&
                  0 === a.length &&
                  t.push(new ValidationError(e.key, a, 'array must have at least one stop')),
                t
              );
            }
            function r(e) {
            ...
            function a(e) {
              ...
              return 'categorical' !== p || 'number' !== t || (isFinite(r) && Math.floor(r) === r)
                ? 'categorical' !== p && 'number' === t && void 0 !== i && r < i
                  ...
                  : ((i = r),
                    'categorical' === p && r in s
                      ? [new ValidationError(e.key, e.value, 'stop domain values must be unique')]
                      : ((s[r] = !0), []))
                : [new ValidationError(e.key, e.value, 'integer expected, found %s', r)];
            }
            function o(e) {
              return validate({
                key: e.key,
            ...
            return (
              'identity' === p &&
                y &&
                v.push(new ValidationError(e.key, e.value, 'missing required property "property"')),
              'identity' === p ||
                e.value.stops ||
                v.push(new ValidationError(e.key, e.value, 'missing required property "stops"')),
              'exponential' === p &&
                'piecewise-constant' === e.valueSpec.function &&
                v.push(new ValidationError(e.key, e.value, 'exponential functions not supported')),
              e.styleSpec.$version >= 8 &&
                (d && !e.valueSpec['property-function']
                  ? v.push(new ValidationError(e.key, e.value, 'property functions not supported'))
                  : y &&
                    !e.valueSpec['zoom-function'] &&
                    v.push(new ValidationError(e.key, e.value, 'zoom functions not supported'))),
              ('categorical' !== p && !c) ||
                void 0 !== e.value.property ||
                v.push(new ValidationError(e.key, e.value, '"property" property is required')),
              v
            );
          };
        },
          ...
          module.exports = function (r) {
            ...
            return a.length
              ...
              : (-1 === e.indexOf('{fontstack}') &&
                  a.push(
                    new ValidationError(t, e, '"glyphs" url must include a "{fontstack}" token')
                  ),
                -1 === e.indexOf('{range}') &&
                  a.push(new ValidationError(t, e, '"glyphs" url must include a "{range}" token')),
                a);
          };
        },
        { '../error/validation_error': 114, './validate_string': 144 },
      ],
      136: [
        function (_dereq_, module, exports) {
          'use strict';
          ...
          module.exports = function (e) {
            ...
            t.type ||
              t.ref ||
              r.push(new ValidationError(a, t, 'either "type" or "ref" is required'));
            ...
            if ('ref' in t) {
              ['type', 'source', 'source-layer', 'filter', 'layout'].forEach(function (e) {
                e in t &&
                  r.push(new ValidationError(a, t[e], '"%s" is prohibited for ref layers', e));
              });
              var y;
              (i.layers.forEach(function (e) {
                ...
                y
                  ? y.ref
                    ? r.push(
                        new ValidationError(a, t.ref, 'ref cannot reference another ref layer')
                      )
                    : (u = unbundle(y.type))
                  : r.push(new ValidationError(a, t.ref, 'ref layer "%s" not found', n)));
            ...
            for (var l in t) {
              ...
              n =
                c && a[c[1]] && a[c[1]].transition
                  ...
                  : a[l]
                    ? n.concat(
                        validate({ key: l, value: t[l], valueSpec: a[l], style: i, styleSpec: r })
                      )
          ...
          module.exports = function (e) {
            ...
            return 'number' !== a
              ...
              : 'minimum' in m && i < m.minimum
                ? [new ValidationError(r, i, '%s is less than the minimum value %s', i, m.minimum)]
          ...
          module.exports = function (e) {
            ...
            for (var v in i)
              i[v].required &&
                void 0 === i[v].default &&
                void 0 === t[v] &&
                n.push(new ValidationError(r, t, 'missing required property "%s"', v));
            return n;
          };
        },
        { '../error/validation_error': 114, '../util/get_type': 122, './validate': 127 },
        ...
        function (_dereq_, module, exports) {
          ...
          module.exports = function (e, t) {
            ...
            return (
              ...
              u.concat(validate({ key: e.key, value: n, valueSpec: p, style: i, styleSpec: a }))
            );
          };
        },
        { '../error/validation_error': 114, '../util/get_type': 122, './validate': 127 },
            ...
            ImageSprite = (function (t) {
              function e(e, i) {
                ...
                (ajax.getJSON(normalizeURL(e, a, '.json'), function (t, e) {
                  t
                    ? r.fire('error', { error: t })
                    : e && ((r.data = e), r.imgData && r.fire('data', { dataType: 'style' }));
                }),
                  ajax.getImage(normalizeURL(e, a, '.png'), function (t, e) {
                    t
                      ...
                      : e &&
                        ...
                        (r.width = e.width),
                        r.data && r.fire('data', { dataType: 'style' }));
                  }));
              }
              return (
                t && (e.__proto__ = t),
            ...
            Light = (function (t) {
              ...
              return (
                    ...
                    for (var e in t) {
                      ...
                      util.endsWith(e, TRANSITION_SUFFIX)
                        ...
                        : null === o || void 0 === o
                          ...
                          : (i._declarations[e] = new StyleDeclaration(i._specifications[e], o));
                    }
                }),
                ...
                (i.prototype._applyLightDeclaration = function (t, i, e, o, n) {
                  ...
                  if (
                    ((null !== i && void 0 !== i) || (i = new StyleDeclaration(a, a.default)),
          ...
          var Evented = _dereq_('../util/evented'),
            ...
            Style = (function (e) {
              function t(t, r, s) {
                ...
                var o = this;
                this._rtlTextPluginCallback = rtlTextPlugin.registerForPluginAvailability(
                  function (e) {
                ...
                var a = function (e, t) {
                  if (e) return void i.fire('error', { error: e });
                ...
                ('string' == typeof t
                  ? ajax.getJSON(mapbox.normalizeStyleURL(t), a)
                  : browser.frame(a.bind(this, null, t)),
                  this.on('data', function (e) {
                    if ('source' === e.dataType && 'metadata' === e.sourceDataType) {
                      var t =
                        !!i.sourceCaches[e.sourceId] && i.sourceCaches[e.sourceId].getSource();
              ...
              return (
                ...
                (t.prototype._validateLayer = function (e) {
                  ...
                  if (e.sourceLayer && t) {
                    var r = t.getSource();
                    ('geojson' === r.type ||
                      (r.vectorLayerIds && -1 === r.vectorLayerIds.indexOf(e.sourceLayer))) &&
                      this.fire('error', {
                        error: new Error(
                          'Source layer "' +
                            e.sourceLayer +
                  ...
                  if (this._loaded) {
                    ...
                    for (var o in i) {
                      ...
                      if (r._updatedAllPaintProps || n.all)
                        a.updatePaintTransitions(e, t, s, r.animationLoop, r.zoomHistory);
                      else
                        for (var l in n)
                ...
                (t.prototype._recalculate = function (e) {
                  ...
                  if (this._loaded) {
                    ...
                    for (var s = 0, i = t._order; s < i.length; s += 1) {
                      var o = i[s],
                        a = t._layers[o];
                      (a.recalculate(e),
                ...
                (t.prototype._updateZoomHistory = function (e) {
                  ...
                  (void 0 === t.lastIntegerZoom &&
                    ...
                    Math.floor(t.lastZoom) < Math.floor(e)
                      ? ((t.lastIntegerZoom = Math.floor(e)), (t.lastIntegerZoomTime = Date.now()))
                      : Math.floor(t.lastZoom) > Math.floor(e) &&
                ...
                (t.prototype.update = function (e, t) {
                  ...
                  if (this._changed) {
                    ...
                    (s.length || i.length || this._updatedSymbolOrder) &&
                      this._updateWorkerLayers(s, i);
                  ...
                  if (
                    ...
                    ((i.style = this),
                      i.setEventedParent(this, function () {
                        return { isSourceLoaded: s.loaded(), source: i.serialize(), sourceId: e };
                      }),
                      i.onAdd(this.map),
                      (this._changed = !0));
                  }
                ...
                (t.prototype.removeSource = function (e) {
                  ...
                  (delete this.sourceCaches[e],
                    ...
                    t.fire('data', { sourceDataType: 'metadata', dataType: 'source', sourceId: e }),
                ...
                (t.prototype.addLayer = function (e, t, r) {
                  ...
                  if (
                    ('object' == typeof e.source &&
                      (this.addSource(s, e.source), (e = util.extend(e, { source: s }))),
                    !this._validate(validateStyle.layer, 'layers.' + s, e, { arrayIndex: -1 }, r))
                  ) {
                    var i = StyleLayer.create(e);
                    (this._validateLayer(i), i.setEventedParent(this, { layer: { id: s } }));
                    var o = t ? this._order.indexOf(t) : this._order.length;
                    if (
                      (this._order.splice(o, 0, s),
                      (this._layers[s] = i),
                      this._removedLayers[s] && i.source)
                    ) {
                ...
                (t.prototype.setFilter = function (e, t) {
                  ...
                  (null !== t &&
                    void 0 !== t &&
                    this._validate(validateStyle.filter, 'layers.' + r.id + '.filter', t)) ||
                ...
                (t.prototype.setLayoutProperty = function (e, t, r) {
                  ...
                  util.deepEqual(s.getLayoutProperty(t), r) ||
                    (s.setLayoutProperty(t, r), this._updateLayer(s));
                }),
                ...
                (t.prototype._flattenRenderedFeatures = function (e) {
                  for (var t = this, r = [], s = this._order.length - 1; s >= 0; s--)
                    for (var i = t._order[s], o = 0, a = e; o < a.length; o += 1) {
                      var n = a[o],
                        l = n[i];
                      if (l)
                        for (var u = 0, h = l; u < h.length; u += 1) {
                          var d = h[u];
                          r.push(d);
                        }
                    }
                ...
                (t.prototype.queryRenderedFeatures = function (e, t, r, s) {
                  ...
                  t &&
                    t.filter &&
                    this._validate(validateStyle.filter, 'queryRenderedFeatures.filter', t.filter);
                  var o = {};
                  if (t && t.layers) {
                ...
                (t.prototype.querySourceFeatures = function (e, t) {
                  t &&
                    t.filter &&
                    this._validate(validateStyle.filter, 'querySourceFeatures.filter', t.filter);
                  var r = this.sourceCaches[e];
                  return r ? QueryFeatures.source(r, t) : [];
                }),
                (t.prototype.addSourceType = function (e, t, r) {
                  return Source.getType(e)
                    ? r(new Error('A source type called "' + e + '" already exists.'))
                    : (Source.setType(e, t),
                      t.workerSourceURL
                  ...
                  return (
                    ...
                    validateStyle.emitErrors(
                      ...
                      e.call(
                        validateStyle,
                        util.extend(
                          { key: t, style: this.serialize(), value: r, styleSpec: styleSpec },
                          s
                        )
                      )
                    )
                ...
                (t.prototype.getIcons = function (e, t, r) {
                  var s = this,
                    i = function () {
                      (s.spriteAtlas.setSprite(s.sprite), s.spriteAtlas.addIcons(t.icons, r));
                    };
                  !this.sprite || this.sprite.loaded() ? i() : this.sprite.on('data', i);
                }),
                (t.prototype.getGlyphs = function (e, t, r) {
                  function s(e, t, s) {
                    (e && console.error(e), (n[s] = t), 0 === --a && r(null, n));
                  }
                  var i = this,
                    o = t.stacks,
      ...
      150: [
        ...
        { '../style-spec/function': 117, '../util/util': 218 },
      ],
      151: [
        function (_dereq_, module, exports) {
          'use strict';
              ...
              return (
                ...
                (i.prototype.setPaintProperty = function (t, i, e, a) {
                  ...
                  if (util.endsWith(t, TRANSITION_SUFFIX))
                    ...
                    (this._paintDeclarations[e || ''] || (this._paintDeclarations[e || ''] = {}),
                    null === i || void 0 === i)
                  )
                ...
                (i.prototype.getPaintProperty = function (t, i) {
                  return (
                    ...
                    util.endsWith(t, TRANSITION_SUFFIX)
                      ? this._paintTransitionOptions[i] && this._paintTransitionOptions[i][t]
                ...
                (i.prototype.updatePaintTransitions = function (t, i, e, a, o) {
                  for (
                    var n = this, r = util.extend({}, this._paintDeclarations['']), s = 0;
                    s < t.length;
                    s++
                  )
                ...
                (i.prototype.recalculate = function (t) {
                  var i = this;
                  for (var e in i._paintTransitions) i.paint[e] = i.getPaintValue(e, { zoom: t });
                  for (var a in i._layoutFunctions) i.layout[a] = i.getLayoutValue(a, { zoom: t });
                }),
                (i.prototype.serialize = function () {
                  var t = this,
                    i = {
                ...
                (i.prototype._applyPaintDeclaration = function (t, i, e, a, o, n) {
                  ...
                  if (
                    ((null !== i && void 0 !== i) || (i = new StyleDeclaration(s, s.default)),
                    !r || r.declaration.json !== i.json)
                  ) {
                    var l = util.extend(
                        { duration: 300, delay: 0 },
                ...
                (i.prototype._updateLayoutValue = function (t) {
                  ...
                  i && i.isFunction
                    ...
                    : (delete this._layoutFunctions[t], (this.layout[t] = this.getLayoutValue(t)));
                }),
      ...
      152: [
        ...
        { '../../data/bucket/circle_bucket': 56, '../style_layer': 151 },
      ],
      153: [
        function (_dereq_, module, exports) {
          'use strict';
        ...
        { '../../data/bucket/fill_extrusion_bucket': 58, '../style_layer': 151 },
      ],
      154: [
        function (_dereq_, module, exports) {
          'use strict';
            ...
            FillStyleLayer = (function (t) {
              ...
              return (
                ...
                (o.prototype.getPaintValueStopZoomLevels = function (o) {
                  return 'fill-outline-color' === o &&
                    void 0 === this.getPaintProperty('fill-outline-color')
                    ? t.prototype.getPaintValueStopZoomLevels.call(this, 'fill-color')
                    : t.prototype.getPaintValueStopZoomLevels.call(this, o);
                }),
                (o.prototype.getPaintInterpolationT = function (o, l) {
                  return 'fill-outline-color' === o &&
                    void 0 === this.getPaintProperty('fill-outline-color')
                    ? t.prototype.getPaintInterpolationT.call(this, 'fill-color', l)
                    : t.prototype.getPaintInterpolationT.call(this, o, l);
                }),
                (o.prototype.isPaintValueFeatureConstant = function (o) {
                  return 'fill-outline-color' === o &&
                    void 0 === this.getPaintProperty('fill-outline-color')
                    ? t.prototype.isPaintValueFeatureConstant.call(this, 'fill-color')
                    : t.prototype.isPaintValueFeatureConstant.call(this, o);
                }),
                (o.prototype.isPaintValueZoomConstant = function (o) {
                  return 'fill-outline-color' === o &&
                    void 0 === this.getPaintProperty('fill-outline-color')
                    ? t.prototype.isPaintValueZoomConstant.call(this, 'fill-color')
                    : t.prototype.isPaintValueZoomConstant.call(this, o);
                }),
        ...
        { '../../data/bucket/fill_bucket': 57, '../style_layer': 151 },
      ],
      155: [
        function (_dereq_, module, exports) {
          'use strict';
        ...
        { '../../data/bucket/line_bucket': 59, '../style_layer': 151 },
      ],
      156: [
        function (_dereq_, module, exports) {
          'use strict';
                ...
                (e.prototype.getLayoutValue = function (e, o, r) {
                  ...
                  switch (e) {
                    ...
                    case 'icon-rotation-alignment':
                      return 'line' === this.getLayoutValue('symbol-placement', o, r)
                        ? 'map'
                        : 'viewport';
        ...
        { '../../data/bucket/symbol_bucket': 60, '../style_layer': 151 },
      ],
      157: [
        function (_dereq_, module, exports) {
          'use strict';
          ...
          ((StyleLayerIndex.prototype.replace = function (e) {
            ...
            (StyleLayerIndex.prototype.update = function (e, r, t) {
              ...
              for (
                var f = groupByLayout(util.values(this._layerConfigs)), p = 0, d = f;
                p < d.length;
                p += 1
              ) {
                var h = d[p],
      ...
      158: [
        function (_dereq_, module, exports) {
          ...
          function interpZoomTransitioned(t, i, e) {
            if (void 0 !== t && void 0 !== i)
              return { from: t.to, fromScale: t.toScale, to: i.to, toScale: i.toScale, t: e };
          }
          var util = _dereq_('../util/util'),
          ...
          ((StyleTransition.prototype.instant = function () {
            ...
            (StyleTransition.prototype._calculateTargetValue = function (t, i) {
              ...
              var e = t.zoom,
                ...
                s = Math.min(
                  (Date.now() - this.zoomHistory.lastIntegerZoomTime) / this.duration,
                  1
                ),
                l = Math.abs(e - o),
                u = interpolate(s, 1, l);
        ...
        { '../style-spec/util/interpolate': 123, '../util/util': 218 },
      ],
      159: [
        function (_dereq_, module, exports) {
          'use strict';
          ((module.exports = _dereq_('../style-spec/validate_style.min')),
            (module.exports.emitErrors = function (r, e) {
              if (e && e.length) {
                for (var t = 0; t < e.length; t++)
                  r.fire('error', { error: new Error(e[t].message) });
                return !0;
              }
              return !1;
            }));
          ...
          function clipLine(n, x, y, o, e) {
            for (var r = [], t = 0; t < n.length; t++)
              for (var i = n[t], u = void 0, d = 0; d < i.length - 1; d++) {
                ...
                (P.x < x && w.x < x) ||
                  (P.x < x
                    ? (P = new Point(x, P.y + (w.y - P.y) * ((x - P.x) / (w.x - P.x)))._round())
                    : w.x < x &&
                      (w = new Point(x, P.y + (w.y - P.y) * ((x - P.x) / (w.x - P.x)))._round()),
                  (P.y < y && w.y < y) ||
                    (P.y < y
                      ? (P = new Point(P.x + (w.x - P.x) * ((y - P.y) / (w.y - P.y)), y)._round())
                      : w.y < y &&
                        (w = new Point(P.x + (w.x - P.x) * ((y - P.y) / (w.y - P.y)), y)._round()),
                    (P.x >= o && w.x >= o) ||
                      (P.x >= o
                        ? (P = new Point(o, P.y + (w.y - P.y) * ((o - P.x) / (w.x - P.x)))._round())
                        : w.x >= o &&
                          (w = new Point(
                            o,
                      ...
                      (P.y >= e && w.y >= e) ||
                        ...
                        (u && P.equals(u[u.length - 1])) || ((u = [P]), r.push(u)),
                        u.push(w)))));
              }
            return r;
          }
      ...
      163: [
        ...
        { '../util/struct_array': 215, 'point-geometry': 36 },
      ],
      164: [
        function (_dereq_, module, exports) {
          'use strict';
          ...
          var Point = _dereq_('point-geometry'),
            ...
            CollisionTile = function (e, t, i, a, r, o, n) {
              ...
              if (
                ...
                (this.yStretch = Math.max(1, a / (i * Math.cos((t / 180) * Math.PI)))),
          ...
          ((CollisionTile.deserialize = function (e, t) {
            ...
            (CollisionTile.prototype.placeCollisionFeature = function (e, t, i) {
              for (
                ...
                ((c.bbox0 = y), (c.bbox1 = g), (c.bbox2 = p), (c.bbox3 = d));
                ...
                if (((c.maxScale = c.unadjustedMaxScale * f), !t))
                  for (var S = a.grid.query(y, g, p, d), P = 0; P < S.length; P++) {
                    var b = r.get(S[P]),
                ...
                if (i) {
                  ...
                  for (var q = 0; q < this.edges.length; q++) {
                    var D = a.edges[q];
                    if (
                      (o = a.getPlacementScale(o, c.anchorPoint, w, D.anchorPoint, D)) >= a.maxScale
                    )
                      return o;
                  }
                }
            ...
            (CollisionTile.prototype.queryRenderedSymbols = function (e, t) {
              ...
              if (
                0 === e.length ||
                (0 === this.grid.keys.length && 0 === this.ignoredGrid.keys.length)
              )
                return a;
              for (
                ...
                for (var y = e[m], g = 0; g < y.length; g++) {
                  var p = y[g].matMult(o);
                  ((l = Math.min(l, p.x)),
                    (c = Math.min(c, p.y)),
                    (h = Math.max(h, p.x)),
              ...
              for (
                var d = this.grid.query(l, c, h, x), u = this.ignoredGrid.query(l, c, h, x), v = 0;
                v < u.length;
                v++
              )
                d.push(u[v]);
              for (
                var M = t / this.perspectiveRatio,
                  T = Math.pow(2, Math.ceil((Math.log(M) / Math.LN2) * 10) / 10),
                  f = 0;
                f < d.length;
                f++
              ) {
                ...
                if (
                  (void 0 === i[P] && (i[P] = {}),
                  !i[P][b] && !(T < S.placementScale || T > S.maxScale))
                ) {
                  ...
                  intersectionTests.polygonIntersectsPolygon(s, G) &&
                    ((i[P][b] = !0), a.push(d[f]));
                }
              }
              return a;
      ...
      167: [
        function (_dereq_, module, exports) {
          ...
          ((GlyphAtlas.prototype.getGlyphs = function () {
            ...
            (GlyphAtlas.prototype.addGlyph = function (t, i, e, h) {
              ...
              var s = i + '#' + e.id;
              if (this.index[s])
                return (this.ids[s].indexOf(t) < 0 && this.ids[s].push(t), this.index[s]);
              ...
              if ((T || (this.resize(), (T = this.atlas.packOne(n, l))), !T))
                return (util.warnOnce('glyph bitmap overflow'), null);
              ((this.index[s] = T), (this.ids[s] = [t]));
              for (var u = this.data, d = e.bitmap, p = 0; p < E; p++)
                for (var A = r.width * (T.y + p + 1) + T.x + 1, _ = a * p, o = 0; o < a; o++)
                  u[A + o] = d[_ + o];
              return ((this.dirty = !0), T);
            }),
            (GlyphAtlas.prototype.resize = function () {
              ...
              if (!(i >= MAX_SIZE || e >= MAX_SIZE)) {
                (this.texture &&
                  (this.gl && this.gl.deleteTexture(this.texture), (this.texture = null)),
        ...
        { '../util/util': 218, '@mapbox/shelf-pack': 2 },
      ],
      168: [
        function (_dereq_, module, exports) {
          'use strict';
            ...
            GlyphSource = (function (t) {
              ...
              return (
                ...
                (e.prototype.getSimpleGlyphs = function (t, e, i, r) {
                  var a = this;
                  (void 0 === this.stacks[t] && (this.stacks[t] = { ranges: {}, cjkGlyphs: {} }),
                    void 0 === this.atlases[t] && (this.atlases[t] = new GlyphAtlas()));
                  for (
                    var l = {}, s = this.stacks[t], o = this.atlases[t], n = {}, h = 0, p = 0;
                    p < e.length;
                    p++
                  )
                    !(function (e) {
                      ...
                      if (
                        ...
                        (isChar['CJK Unified Ideographs'](e) || isChar['Hangul Syllables'](e))
                      ) {
                      ...
                      } else (void 0 === n[r] && ((n[r] = []), h++), n[r].push(e));
                    })(e[p]);
                  h || r(void 0, l, t);
                  var y = function (e, s, p) {
                    if (e) return void a.fire('error', { error: e });
                    for (
                      var y = (a.stacks[t].ranges[s] = p.stacks[0]), u = 0;
                      u < n[s].length;
                      u++
                    ) {
                      var c = n[s][u],
                ...
                (e.prototype.createTinySDF = function (t, e) {
                  return new TinySDF(24, 3, 8, 0.25, t, e);
                }),
                (e.prototype.loadCJKGlyph = function (t, e) {
                  ...
                  if (!i) {
                    ...
                    (/bold/i.test(t)
                      ...
                      : /medium/i.test(t)
                        ? (r = '500')
                        : /light/i.test(t) && (r = '200'),
                      (i = this.tinySDFs[t] =
                        this.createTinySDF(this.localIdeographFontFamily, r)));
                  }
                  return {
                    id: e,
                ...
                (e.prototype.loadRange = function (t, e, i) {
                  ...
                  if (r[e]) r[e].push(i);
                    ...
                    this.loadPBF(l, function (t, i) {
                      for (
                        var a = !t && new Glyphs(new Protobuf(i.data)), l = 0;
                        l < r[e].length;
                        l++
                      )
                        r[e][l](t, e, a);
        ...
        function (_dereq_, module, exports) {
          ...
          function getLabelPlaneMatrix(e, t, a, r, n) {
            ...
            return (
              t
                ? (mat4.identity(i),
                  mat4.scale(i, i, [1 / n, 1 / n, 1]),
                  a || mat4.rotateZ(i, i, r.angle))
                : (mat4.scale(i, i, [r.width / 2, -r.height / 2, 1]),
            ...
            return (
              t
                ...
                : (mat4.scale(i, i, [1, -1, 1]),
                  mat4.translate(i, i, [-1, -1, 0]),
                  mat4.scale(i, i, [2 / r.width, 2 / r.height, 1])),
              i
            );
          }
          function project(e, t) {
            var a = [e.x, e.y, 0, 1];
            return (vec4.transformMat4(a, a, t), new Point(a[0] / a[3], a[1] / a[3]));
          }
          function isVisible(e, t, a, r) {
            var n = e[0] / e[3],
              i = e[1] / e[3];
            return (
              n >= -a[0] && n <= a[0] && i >= -a[1] && i <= a[1] && r.frameHistory.isVisible(t)
            );
          }
          function updateLineLabels(e, t, a, r, n, i, l, o, s, u) {
            var p = r ? e.textSizeData : e.iconSizeData,
              ...
              c = r
                ? e.buffers.glyph.dynamicLayoutVertexArray
                : e.buffers.icon.dynamicLayoutVertexArray;
            c.clear();
            for (
              var f = e.lineVertexArray, g = r ? e.placedGlyphArray : e.placedIconArray, h = 0;
              h < g.length;
              h++
            ) {
              var d = g.get(h),
              ...
              if ((vec4.transformMat4(x, x, t), isVisible(x, d.placementZoom, y, a))) {
                var v = x[3],
                  ...
                  S = {},
                  I = placeGlyphsAlongLine(d, A, !1, o, t, n, i, e.glyphOffsetArray, f, c, G, S);
                (I.notEnoughRoom ||
                  (I.needsFlipping &&
                    placeGlyphsAlongLine(d, A, !0, o, t, n, i, e.glyphOffsetArray, f, c, G, S)
                      .notEnoughRoom)) &&
                  hideGlyphs(d.numGlyphs, c);
              } else hideGlyphs(d.numGlyphs, c);
            }
            r
              ? e.buffers.glyph.dynamicLayoutVertexBuffer.updateData(c.serialize())
              : e.buffers.icon.dynamicLayoutVertexBuffer.updateData(c.serialize());
          }
          function placeGlyphsAlongLine(e, t, a, r, n, i, l, o, s, u, p, m) {
            ...
            if (e.numGlyphs > 1) {
              ...
              var G = project(L.point, l),
                S = project(A.point, l);
              if (r && !a && (e.vertical ? G.y < S.y : G.x > S.x)) return { needsFlipping: !0 };
              y = [L];
              ...
              if (r && !a) {
                ...
                if (e.vertical ? z.y > P.y : z.x < P.x) return { needsFlipping: !0 };
              }
              var D = o.get(e.glyphStartIndex),
                w = placeGlyphAlongLine(
                  c * D.offsetX,
                  f,
                  g,
                  a,
            ...
            for (var F = e.placementZoom, V = 0, j = y; V < j.length; V += 1) {
              var X = j[V];
          ...
          function placeGlyphAlongLine(e, t, a, r, n, i, l, o, s, u, p) {
            var m = r ? e - t : e + t,
              y = m > 0 ? 1 : -1,
              c = 0;
            (r && ((y *= -1), (c = Math.PI)), y < 0 && (c += Math.PI));
            for (
              var f = y > 0 ? l + i : l + i + 1, g = n, h = n, d = 0, x = 0, v = Math.abs(m);
              d + x <= v;
            ) {
            ...
            return (
              ...
              { point: A, angle: c + Math.atan2(g.y - h.y, g.x - h.x) }
            );
          }
      ...
      171: [
        function (_dereq_, module, exports) {
          ...
          function getIconQuads(t, e, i, n, o, a, u) {
            ...
            if ('none' !== c['icon-text-fit'] && o) {
              var w = p - f,
                ...
                L = 'width' === c['icon-text-fit'] ? 0.5 * (Q - y) : 0,
                V = 'height' === c['icon-text-fit'] ? 0.5 * (v - w) : 0,
            ...
            if (O) {
              var j = Math.sin(O),
                k = Math.cos(O),
                A = [k, -j, j, k];
              (l._matMult(A), r._matMult(A), h._matMult(A), d._matMult(A));
            }
            return [
              new SymbolQuad(
                l,
          ...
          function getGlyphQuads(t, e, i, n, o, a) {
            for (
              var u = (i.getLayoutValue('text-rotate', o, a) * Math.PI) / 180,
                l = i.getLayoutValue('text-offset', o, a).map(function (t) {
                  return 24 * t;
                }),
              ...
              if (c) {
                ...
                if (g) {
                  ...
                  if (
                    (0 !== s.angle &&
                      (M._sub(Q)._rotate(s.angle)._add(Q),
                      P._sub(Q)._rotate(s.angle)._add(Q),
                      b._sub(Q)._rotate(s.angle)._add(Q),
                      v._sub(Q)._rotate(s.angle)._add(Q)),
                    u)
                  ) {
                    var R = Math.sin(u),
                      I = Math.cos(u),
                      S = [I, -R, R, I];
                    (M._matMult(S), P._matMult(S), b._matMult(S), v._matMult(S));
                  }
        ...
        function (_dereq_, module, exports) {
          ...
          function breakLines(t, e) {
            for (var i = [], n = 0, a = 0, r = e; a < r.length; a += 1) {
              var o = r[a];
              (i.push(t.substring(n, o)), (n = o));
            }
            return (n < t.length && i.push(t.substring(n, t.length)), i);
          }
          function shapeText(t, e, i, n, a, r, o, s, l, c) {
            ...
            return (
              (u = rtlTextPlugin.processBidirectionalText
                ? rtlTextPlugin.processBidirectionalText(h, determineLineBreaks(h, o, i, e))
                : breakLines(h, determineLineBreaks(h, o, i, e))),
          ...
          function evaluateBreak(t, e, i, n, a, r) {
            for (
              var o = null, s = calculateBadness(e, i, a, r), l = 0, c = n;
              l < c.length;
              l += 1
            ) {
              var h = c[l],
          ...
          function determineLineBreaks(t, e, i, n) {
            ...
            if (!t) return [];
            for (
              var a = [], r = determineAverageLineWidth(t, e, i, n), o = 0, s = 0;
              s < t.length;
              s++
            ) {
              ...
              (c && !whitespace[l] && (o += c.advance + e),
                s < t.length - 1 &&
                  (breakable[l] || scriptDetection.charAllowsIdeographicBreaking(l)) &&
                  a.push(
                    evaluateBreak(s + 1, o, r, a, calculatePenalty(l, t.charCodeAt(s + 1)), !1)
                  ));
            }
          ...
          function shapeLines(t, e, i, n, a, r, o, s, l, c) {
            var h = 0,
              ...
              d = 'right' === r ? 1 : 'left' === r ? 0 : 0.5;
            for (var v in i) {
              var f = i[v].trim();
              if (f.length) {
                for (var b = p.length, m = 0; m < f.length; m++) {
                  var x = f.charCodeAt(m),
                    B = e[x];
                  B &&
                    (scriptDetection.charHasUprightVerticalOrientation(x) &&
                    s !== WritingMode.horizontal
                      ? (p.push(new PositionedGlyph(x, h, 0, B, -Math.PI / 2)), (h += c + l))
                      : (p.push(new PositionedGlyph(x, h, u, B, 0)), (h += B.advance + l)));
                }
                if (p.length !== b) {
                  var k = h - l;
                  ((g = Math.max(k, g)), justifyLine(p, e, b, p.length - 1, d));
                }
                ((h = 0), (u += n));
              } else u += n;
            }
          ...
          function justifyLine(t, e, i, n, a) {
            if (a)
              for (var r = e[t[n].codePoint].advance, o = (t[n].x + r) * a, s = i; s <= n; s++)
                t[s].x -= o;
          }
          function align(t, e, i, n, a, r, o) {
            for (var s = (e - i) * a, l = (-n * o + 0.5) * r, c = 0; c < t.length; c++)
              ((t[c].x += s), (t[c].y += l));
          }
        ...
        function (_dereq_, module, exports) {
          ...
          function copyBitmap(t, e, i, r, a, h, s, o, n, d, p) {
            var l,
              ...
              g = o * h + s;
            if (p)
              for (g -= h, u = -1; u <= d; u++, g += h)
                for (f = (((u + d) % d) + r) * e + i, l = -1; l <= n; l++)
                  a[g + l] = t[f + ((l + n) % n)];
            else
              for (u = 0; u < d; u++, f += e, g += h) for (l = 0; l < n; l++) a[g + l] = t[f + l];
          }
          var ShelfPack = _dereq_('@mapbox/shelf-pack'),
            browser = _dereq_('../util/browser'),
            util = _dereq_('../util/util'),
                ...
                (e.prototype.addImage = function (t, e, i) {
                  ...
                  if (
                    (e instanceof window.HTMLImageElement
                      ? ((r = e.width), (a = e.height), (e = browser.getImageData(e)), (h = 1))
                      : ((r = i.width), (a = i.height), (h = i.pixelRatio || 1)),
                    ArrayBuffer.isView(e) && (e = new Uint32Array(e.buffer)),
                    !(e instanceof Uint32Array))
                  )
                    return this.fire('error', {
                      error: new Error(
                        'Image provided in an invalid format. Supported formats are HTMLImageElement and ArrayBufferView.'
                      ),
                    });
                  if (this.images[t])
                    return this.fire('error', {
                  ...
                  ((this.images[t] = { rect: s, width: r, height: a, pixelRatio: h, sdf: !1 }),
                    this.copy(e, r, s, { x: 0, y: 0, width: r, height: a }, !1),
                    this.fire('data', { dataType: 'style' }));
                }),
                (e.prototype.removeImage = function (t) {
                  var e = this.images[t];
                  if ((delete this.images[t], !e))
                    return this.fire('error', {
                      error: new Error('No image with this name exists.'),
                    });
                  (this.shelfPack.unref(e.rect), this.fire('data', { dataType: 'style' }));
                }),
        ...
        function (_dereq_, module, exports) {
          ...
          function evaluateSizeForFeature(e, o, t) {
            ...
            return e.isFeatureConstant
              ...
              : e.isZoomConstant
                ? t.lowerSize / 10
                : interpolate.number(t.lowerSize / 10, t.upperSize / 10, i.uSizeT);
          }
            ...
            if (e.isZoomConstant || e.isFeatureConstant)
              if (e.isFeatureConstant && !e.isZoomConstant) {
                ...
                if ('interval' === e.functionType)
                  n = t.getLayoutValue(i ? 'text-size' : 'icon-size', { zoom: o.zoom });
                else {
                  var r =
          ...
          module.exports = function (e, t) {
            ...
            function a(t) {
              (e.stop(),
                ...
                !t.touches ||
                  t.touches.length > 1 ||
                  (b ? (clearTimeout(b), (b = null), h('dblclick', t)) : (b = setTimeout(l, 300))));
            }
            function i(e) {
              f('touchmove', e);
            }
              ...
              return (
                ...
                (e.prototype.panBy = function (t, e, i) {
                  return (
                    ...
                    this.panTo(this.transform.center, util.extend({ offset: t }, e), i)
                  );
                }),
                ...
                (e.prototype.fitBounds = function (t, e, i) {
                  ...
                  return f < 0 || m < 0
                    ...
                    : ((e.center = h.unproject(p.add(u).div(2))),
                      (e.zoom = Math.min(h.scaleZoom(h.scale * Math.min(m, f)), e.maxZoom)),
                      (e.bearing = 0),
                ...
                (e.prototype.jumpTo = function (t, e) {
                  ...
                  var i = this.transform,
                    ...
                    r = !1;
                  return (
                    'zoom' in t && i.zoom !== +t.zoom && ((o = !0), (i.zoom = +t.zoom)),
                ...
                (e.prototype.easeTo = function (t, e) {
                  var i = this;
                  (this.stop(),
                    (t = util.extend({ offset: [0, 0], duration: 500, easing: util.ease }, t)),
                  ...
                  var f,
                    ...
                    v = o.zoomScale(s - n);
                  return (
                    t.around && ((f = LngLat.convert(t.around)), (g = o.locationPoint(f))),
                    (this.zooming = s !== n),
                    (this.rotating = r !== h),
                    (this.pitching = p !== a),
                ...
                (e.prototype.flyTo = function (t, e) {
                  function i(t) {
                    var e =
                      (M * M - z * z + (t ? -1 : 1) * L * L * E * E) / (2 * (t ? M : z) * L * E);
                  ...
                  (this.stop(),
                    (t = util.extend(
                      { offset: [0, 0], speed: 1.2, curve: 1.42, easing: util.ease },
                      t
                    )));
                ...
                (e.prototype._smoothOutEasing = function (t) {
                  ...
                  return (
                    (this._prevEase = { start: new Date().getTime(), duration: t, easing: e }),
                    e
                  );
                }),
                e
      ...
      178: [
          ...
          ((AttributionControl.prototype.getDefaultPosition = function () {
            ...
            (AttributionControl.prototype.onAdd = function (t) {
              ...
              return (
                ...
                void 0 === i &&
                  (this._map.on('resize', this._updateCompact), this._updateCompact()),
                this._container
              );
            }),
        ...
        { '../../util/config': 201, '../../util/dom': 204, '../../util/util': 218 },
      ],
      179: [
        function (_dereq_, module, exports) {
          'use strict';
        ...
        { '../../util/dom': 204, '../../util/util': 218, '../../util/window': 199 },
      ],
      180: [
        function (_dereq_, module, exports) {
          'use strict';
          function checkGeolocationSupport(t) {
            void 0 !== supportsGeolocation
              ...
              : void 0 !== window.navigator.permissions
                ? window.navigator.permissions.query({ name: 'geolocation' }).then(function (o) {
                    ...
                    this.options.trackUserLocation &&
                      this._map.on('movestart', function (t) {
                        t.geolocateSource ||
                          ...
                          o._geolocateButton.classList.add('mapboxgl-ctrl-geolocate-background'),
                          o._geolocateButton.classList.remove('mapboxgl-ctrl-geolocate-active'),
            ...
            (NavigationControl.prototype.onAdd = function (t) {
              return (
                ...
                (this._zoomInButton = this._createButton(
                  className + '-icon ' + className + '-zoom-in',
                  'Zoom In',
                  t.zoomIn.bind(t)
                )),
                (this._zoomOutButton = this._createButton(
                  className + '-icon ' + className + '-zoom-out',
                  'Zoom Out',
                  t.zoomOut.bind(t)
                )),
                (this._compass = this._createButton(
                  className + '-icon ' + className + '-compass',
                  'Reset North',
                  t.resetNorth.bind(t)
                )),
        ...
        function (_dereq_, module, exports) {
          ...
          ((BoxZoomHandler.prototype.isEnabled = function () {
            ...
            (BoxZoomHandler.prototype._onMouseDown = function (o) {
              o.shiftKey &&
                0 === o.button &&
                (window.document.addEventListener('mousemove', this._onMouseMove, !1),
                ...
                (this._finish(),
                  e.x === t.x && e.y === t.y
                    ...
                    : this._map
                        ...
                        .fire('boxzoomend', { originalEvent: o, boxZoomBounds: n }));
              }
            }),
        ...
        function (_dereq_, module, exports) {
          ...
          ((DoubleClickZoomHandler.prototype.isEnabled = function () {
            ...
            (DoubleClickZoomHandler.prototype.enable = function () {
              this.isEnabled() ||
                (this._map.on('dblclick', this._onDblClick), (this._enabled = !0));
            }),
            (DoubleClickZoomHandler.prototype.disable = function () {
              this.isEnabled() &&
                (this._map.off('dblclick', this._onDblClick), (this._enabled = !1));
            }),
        ...
        function (_dereq_, module, exports) {
          ...
          ((DragRotateHandler.prototype.isEnabled = function () {
            ...
            (DragRotateHandler.prototype.enable = function () {
              this.isEnabled() ||
                (this._el.addEventListener('mousedown', this._onDown), (this._enabled = !0));
            }),
            (DragRotateHandler.prototype.disable = function () {
              this.isEnabled() &&
                (this._el.removeEventListener('mousedown', this._onDown), (this._enabled = !1));
            }),
            ...
            (DragRotateHandler.prototype._onUp = function (t) {
              ...
              if (
                ...
                ((_ += p * u * (l / 2)),
                  ...
                  i.rotateTo(
                    _,
                    { duration: 1e3 * l, easing: inertiaEasing, noMoveStart: !0 },
                    { originalEvent: t }
                  ));
              }
            }),
        ...
        function (_dereq_, module, exports) {
          ...
          ((KeyboardHandler.prototype.isEnabled = function () {
            ...
            (KeyboardHandler.prototype.enable = function () {
              this.isEnabled() ||
                (this._el.addEventListener('keydown', this._onKeyDown, !1), (this._enabled = !0));
            }),
          ...
          ((ScrollZoomHandler.prototype.isEnabled = function () {
            ...
            (ScrollZoomHandler.prototype._onWheel = function (e) {
              ...
              'wheel' === e.type
                ...
                : 'mousewheel' === e.type && ((t = -e.wheelDeltaY), safari && (t /= 3));
              var o = browser.now(),
                i = o - (this._time || 0);
                ...
                0 !== t && t % 4.000244140625 == 0
                  ...
                  : 0 !== t && Math.abs(t) < 4
                    ...
                    : i > 400
                      ...
                      : this._type ||
                        ((this._type = Math.abs(i * t) < 200 ? 'trackpad' : 'wheel'),
                        this._timeout &&
              ...
              if (2 === t.touches.length) {
                ...
                if (this._gestureIntent) {
                  ...
                  ('rotate' === this._gestureIntent && (h.bearing = this._startBearing + r),
                    ('zoom' !== this._gestureIntent && 'rotate' !== this._gestureIntent) ||
            ...
            Map = (function (t) {
              function e(e) {
                ...
                if (
                  ...
                  if (
                    ((this._container = window.document.getElementById(e.container)),
                    !this._container)
                  )
              ...
              return (
                (e.prototype.addControl = function (t, e) {
                  ...
                  return (
                    -1 !== e.indexOf('bottom') ? i.insertBefore(o, i.firstChild) : i.appendChild(o),
                    this
                  );
                }),
                ...
                (e.prototype.getBounds = function () {
                  ...
                  return (
                    (this.transform.angle || this.transform.pitch) &&
                      (t.extend(this.transform.pointLocation(new Point(this.transform.size.x, 0))),
                ...
                (e.prototype.setMinZoom = function (t) {
                  if (
                    (t = null === t || void 0 === t ? defaultMinZoom : t) >= defaultMinZoom &&
                ...
                (e.prototype.setMaxZoom = function (t) {
                  if (
                    (t = null === t || void 0 === t ? defaultMaxZoom : t) >= this.transform.minZoom
                  )
                    return (
                ...
                (e.prototype.on = function (e, o, i) {
                  ...
                  var s = (function () {
                      ...
                      return {
                        ...
                        delegates: {
                          mousemove: function (s) {
                            ...
                            n.length
                              ? t ||
                                ((t = !0), i.call(r, util.extend({ features: n }, s, { type: e })))
                              : (t = !1);
                          },
                          mouseout: function () {
                            t = !1;
                      ...
                      return {
                        ...
                        delegates: {
                          mousemove: function (t) {
                            r.queryRenderedFeatures(t.point, { layers: [o] }).length
                              ? (s = !0)
                              : s && ((s = !1), i.call(r, util.extend({}, t, { type: e })));
                          },
                          mouseout: function (t) {
                            s && ((s = !1), i.call(r, util.extend({}, t, { type: e })));
                          },
                    ...
                    return { layer: o, listener: i, delegates: ((a = {}), (a[e] = n), a) };
                    var a;
                  })();
                ...
                (e.prototype.setStyle = function (t, e) {
                  ...
                  return (
                    ...
                    t
                      ? ((this.style = t instanceof Style ? t : new Style(t, this, e)),
                ...
                (e.prototype._setupContainer = function () {
                  ...
                  var i = (this._controlContainer = DOM.create(
                      'div',
                ...
                (e.prototype._render = function () {
                  return (
                    ...
                    this.style &&
                      this._sourcesDirty &&
                      ((this._sourcesDirty = !1), this.style._updateSources(this.transform)),
                ...
                (o.showCollisionBoxes.set = function (t) {
                  this._showCollisionBoxes !== t &&
                    ((this._showCollisionBoxes = t), this.style._redoPlacement());
                }),
                ...
                (o.prototype._update = function () {
                  if (this._map && this._lngLat && this._content) {
                    ...
                    if (!t) {
                      ...
                      ((t =
                        this._pos.y + o.bottom.y < n
                          ? ['top']
                          : this._pos.y > this._map.transform.height - n
                            ? ['bottom']
                            : []),
                        this._pos.x < e / 2
                          ? t.push('left')
                          : this._pos.x > this._map.transform.width - e / 2 && t.push('right'),
          ...
          ((Actor.prototype.send = function (t, e, r, a, s) {
            ...
            (r && (this.callbacks[i] = r),
              this.target.postMessage(
                { targetMapId: s, sourceMapId: this.mapId, type: t, id: String(i), data: e },
                a
              ));
          }),
            (Actor.prototype.receive = function (t) {
              ...
              if (!a.targetMapId || this.mapId === a.targetMapId) {
                ...
                if ('<response>' === a.type)
                  ...
                  this.parent[a.type](a.sourceMapId, a.data, i);
      ...
      198: [
        ...
        { '../../source/worker': 110, '../window': 199, webworkify: 51 },
      ],
      199: [
        function (_dereq_, module, exports) {
          'use strict';
            ...
            (Dispatcher.prototype.send = function (t, r, o, i, e) {
              return (
                ('number' != typeof i || isNaN(i)) &&
                  (i = this.currentActor = (this.currentActor + 1) % this.actors.length),
          ...
          ((Evented.prototype.on = function (e, t) {
            ...
            (Evented.prototype.fire = function (e, t) {
              ...
              if (this.listens(e)) {
                ...
                for (
                  var i = this._listeners && this._listeners[e] ? this._listeners[e].slice() : [],
                    s = 0;
                  s < i.length;
                  s++
                )
      ...
      206: [
        function (_dereq_, module, exports) {
            ...
            for (var n = !1, r = 1 / 0, o = 0; o < t.length; o++)
              for (var i = t[o], l = 0, u = i.length, s = u - 1; l < u; s = l++) {
                var a = i[l],
                  h = i[s];
                (a.y > e.y != h.y > e.y &&
                  e.x < ((h.x - a.x) * (e.y - a.y)) / (h.y - a.y) + a.x &&
                  (n = !n),
          ...
          function getCentroidCell(e) {
            for (
              var t = 0, n = 0, r = 0, o = e[0], i = 0, l = o.length, u = l - 1;
              i < l;
              u = i++
            ) {
              var s = o[i],
          ...
          module.exports = function (e, t, n) {
            ...
            return (
              n && (console.log('num probes: ' + c), console.log('best distance: ' + m.d)),
              m.p
            );
          };
        },
        { './intersection_tests': 209, 'point-geometry': 36, tinyqueue: 40 },
      ],
      207: [
        function (_dereq_, module, exports) {
          'use strict';
          ...
          function multiPolygonIntersectsBufferedMultiLine(n, t, e) {
            for (var r = 0; r < t.length; r++)
              for (var o = t[r], i = 0; i < n.length; i++) {
                var l = n[i];
                if (l.length >= 3)
                  for (var u = 0; u < o.length; u++) if (polygonContainsPoint(l, o[u])) return !0;
          ...
          ((exports.isMapboxURL = isMapboxURL),
            ...
            (exports.normalizeSpriteURL = function (r, e, t, a) {
              ...
              return isMapboxURL(r)
                ? ((o.path = '/styles/v1' + o.path + '/sprite' + e + t), makeAPIURL(o, a))
          ...
          ((module.exports.allowsIdeographicBreaking = function (a) {
            ...
            (exports.charHasUprightVerticalOrientation = function (a) {
              return (
                ...
                (!(a < 4352) &&
                  (!!isChar['Bopomofo Extended'](a) ||
                    !!isChar.Bopomofo(a) ||
                    !(!isChar['CJK Compatibility Forms'](a) || (a >= 65097 && a <= 65103)) ||
                    !!isChar['CJK Compatibility Ideographs'](a) ||
                    !!isChar['CJK Compatibility'](a) ||
                    !!isChar['CJK Radicals Supplement'](a) ||
                    !!isChar['CJK Strokes'](a) ||
                    ...
                    !!isChar['Unified Canadian Aboriginal Syllabics Extended'](a) ||
                    !!isChar['Vertical Forms'](a) ||
            ...
            (exports.charHasNeutralVerticalOrientation = function (a) {
              return (
                ...
                !(!isChar['Miscellaneous Symbols'](a) || (a >= 9754 && a <= 9759)) ||
                !(
          ...
          function createStructArrayType(t) {
            ...
            for (var y = 0, c = o; y < c.length; y += 1)
              for (var h = c[y], u = 0; u < h.components; u++) {
                ...
                if (f in p.prototype)
                  throw new Error(f + ' is a reserved name and cannot be used as a member name.');
          ...
          function createEmplaceBack(t, e) {
            for (
              ...
              var s = o[a],
                p = sizeOf(s.type);
              r.indexOf(p) < 0 &&
                (r.push(p), (i += 'var o' + p.toFixed(0) + ' = i * ' + (e / p).toFixed(0) + ';\n'));
        ...
        function (_dereq_, module, exports) {
          ...
          ((Throttler.prototype.invoke = function () {
            ...
            if (!this.pendingInvocation) {
              ...
              o <= 0
                ? ((this.lastInvocation = browser.now()), this.throttledFunction())
            ...
            (Throttler.prototype.stop = function () {
              this.pendingInvocation &&
                (clearTimeout(this.pendingInvocation), (this.pendingInvocation = void 0));
            }),
      ...
      218: [
        function (_dereq_, module, exports) {
          ...
          ((exports.warnOnce = function (r) {
            warnOnceHistory[r] ||
              ('undefined' != typeof console && console.warn(r), (warnOnceHistory[r] = !0));
          }),
            ...
            (exports.calculateSignedArea = function (r) {
              for (
                var e = 0, t = 0, n = r.length, o = n - 1, a = void 0, i = void 0;
                t < n;
                o = t++
              )
        ...
        { '../geo/coordinate': 71, '@mapbox/unitbezier': 4, 'point-geometry': 36 },
      ],
      219: [
        function (_dereq_, module, exports) {
          'use strict';
